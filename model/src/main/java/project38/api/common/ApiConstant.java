...
//    public static String API_DOMAIN = "http://103.211.124.82:8080/api/";
    ...
    public static String API_REGISTER_ACCOUNTUNIQUE = API_DOMAIN + "member/getAccountUniqueFlag.json";//用户名是否唯一

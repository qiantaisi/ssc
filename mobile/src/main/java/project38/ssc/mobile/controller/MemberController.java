...
//        modelMap.put("bankCardListResult", ApiUtils.getSystemBankCard(uid, token));
    ...
    public ModelAndView yhkglIndex() throws Exception {
        ...
        modelMap.put("userBankCardList", ApiUtils.getUserBankCardList(uid, token).getUserBankCardList());
    ...
    public ModelAndView yhkglDetail(Long userBankCardId) throws Exception {
        ...
        modelMap.put("userBankCard", ApiUtils.getUserBankCard(uid, token, userBankCardId));
    ...
    public String checkOnline() {
        Long uid = this.getUid(httpServletRequest);
        String token = this.getToken(httpServletRequest);
        return JSONUtils.toJSONStr(ApiUtils.checkOnline(uid, token));
    }
    ...
    public ModelAndView czjlDetail(String orderNo) throws Exception {
        ...
        Map<String, Object> modelMap = new HashMap<String, Object>();
        modelMap.put("data", ApiUtils.getDeposit(uid, token, orderNo));
    ...
    public ModelAndView tzjlDetail(String orderNumber) throws Exception {
        ...
        Map<String, Object> modelMap = new HashMap<String, Object>();
        modelMap.put("data", ApiUtils.getSscBets(uid, token, orderNumber));
    ...
    public ModelAndView znxDetail(Long noticeId) throws Exception {
        ...
        Map<String, Object> modelMap = new HashMap<String, Object>();
        modelMap.put("data", ApiUtils.getUserInbox(uid, token, noticeId));

        // 标记已读
        Long[] idList = new Long[] {noticeId};
        ApiUtils.readUserInboxNotice(uid, token, idList);
    ...
    public ModelAndView ck(Long noticeId) throws Exception {
        ...
        // QQ转账
        modelMap.put("qqzzList", ApiUtils.getSystemQq(uid, token).getSkInfoList());

        //获取在线支付信息
        modelMap.put("zxzfInfoList", ApiUtils.getSystemPayonline(uid, token, 1, new Integer[] {1, 3}).getSystemPayOnlineList());
        //支付宝支付信息
        modelMap.put("zfbzfInfoList", ApiUtils.getSystemPayonline(uid, token, 2, new Integer[] {1, 3}).getSystemPayOnlineList());
        //微信支付信息
        modelMap.put("wxzfInfoList", ApiUtils.getSystemPayonline(uid, token, 3, new Integer[] {1, 3}).getSystemPayOnlineList());
        //QQ支付信息
        modelMap.put("qqzfInfoList", ApiUtils.getSystemPayonline(uid, token, 4, new Integer[] {1, 3}).getSystemPayOnlineList());
    ...
    public ModelAndView cqkQk(Long noticeId) throws Exception {
        ...
        modelMap.put("userBankList", JSONUtils.toJSONStr(ApiUtils.getUserBankCardList(uid, token).getUserBankCardList()));

        QkSettingResult qkSettingResult = ApiUtils.getQkSetting();
    ...
    public ModelAndView gonggaoDetail(String pk) throws Exception {
        ...
        Map<String, Object> modelMap = new HashMap<String, Object>();
        modelMap.put("data", ApiUtils.getPopupNotice(pk));
    ...
    public ModelAndView tgzqTdtzDetail(String orderNumber) throws Exception {
        ...
        modelMap.put("data", ApiUtils.getAgentSscBets(uid, token, orderNumber));
    ...
    public ModelAndView cqkZzWxzz(String pk) throws Exception {
        ...
        Map<String, Object> modelMap = new HashMap<String, Object>();
        modelMap.put("skInfoList", JSONUtils.toJSONStr(ApiUtils.getSystemWeixin(uid, token).getSkInfoList()));
        LayerInfoResult layerInfoResult = ApiUtils.getLayer(uid, token);
        if (!layerInfoResult.getCanAgent()) {
            return this.renderView("member/noaccess", modelMap);
        }
    ...
    public ModelAndView cqkZzQqzz(String pk) throws Exception {
        ...
        Map<String, Object> modelMap = new HashMap<String, Object>();
        modelMap.put("skInfoList", JSONUtils.toJSONStr(ApiUtils.getSystemQq(uid, token).getSkInfoList()));
        LayerInfoResult layerInfoResult = ApiUtils.getLayer(uid, token);
        if (!layerInfoResult.getCanAgent()) {
            return this.renderView("member/noaccess", modelMap);
        }
    ...
    public ModelAndView cqkZzZfbzz(String pk) throws Exception {
        ...
        Map<String, Object> modelMap = new HashMap<String, Object>();
        modelMap.put("skInfoList", JSONUtils.toJSONStr(ApiUtils.getSystemAlipay(uid, token).getSkInfoList()));
        LayerInfoResult layerInfoResult = ApiUtils.getLayer(uid, token);
        if (!layerInfoResult.getCanAgent()) {
            return this.renderView("member/noaccess", modelMap);
        }
    ...
    public ModelAndView cqkZzCftzz(String pk) throws Exception {
        ...
        Map<String, Object> modelMap = new HashMap<String, Object>();
        modelMap.put("skInfoList", JSONUtils.toJSONStr(ApiUtils.getSystemTenpay(uid, token).getSkInfoList()));
        LayerInfoResult layerInfoResult = ApiUtils.getLayer(uid, token);
        if (!layerInfoResult.getCanAgent()) {
            return this.renderView("member/noaccess", modelMap);
        }
    ...
    public ModelAndView tkjlczjlDetail(String orderNo) throws Exception {
        ...
        Map<String, Object> modelMap = new HashMap<String, Object>();
        modelMap.put("data", ApiUtils.getWithdraw(uid, token, orderNo));

...
<head>
    ...
    <style>
        ...
        *+html .clearfix { height: 1% }
        ...
        .ios9{ width:100%; height:156px; z-index:9; top:0; left:0; background:rgba(142,116,78,0.9); display: none}
...
<div class="ios9">
    <div class="ios9_box">
        ...
        <div class="info2">
            <a href="/CertInstallGuide.ashx?c=gw&t=2&p=4&device=1" onclick="clickStat('hm1005')" class="rhxr nosafari">如何信任？</a>
            <a href="/CertInstallGuide.ashx?c=gw&t=2&p=4&device=1" onclick="clickStat('hm1004')" id="ljxr_btn" class="ljxr_btn nosafari">立即信任</a>
        </div>
    </div>
</div>
<div id='popweixin'>
    ...
    <div class="yd1 clearfix">
        ...
        <div class="yd1_rt">
            ...
            <div class="yd1_rt_text">
                更新日期：2017年07月21日<br/>
                版本：IOS${data.iosVersion}/Android${data.androidVersion}<br/>
                大小：3.9MB<br/>
                语言：简体中文
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function banben() {
        ...
        if (ios_bb >= 9) {
            ...
            var certInstallGuide = "/CertInstallGuide.ashx?c=gw&t=2&p=4&device=1";var nosafariArray = document.getElementsByClassName("nosafari");var href = certInstallGuide.replace(/device=\d+/g, "device=3");for (var i = 0; i < nosafariArray.length; i++){nosafariArray[i].setAttribute("href", href);}
            clickStat('hm1001');
        }
    }
    banben();

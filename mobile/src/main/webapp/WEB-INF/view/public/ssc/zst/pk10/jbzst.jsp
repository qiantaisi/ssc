        ...
        <div class="content cl-601 zst-cl-10">
            <div class="cl-600" id="ssc-parent-menu">
                <div class="re-cl-602">
                    ...
                    <span class="goucai"><a id="blink" href="<%=basePath%>ssc/gcdt/pk10.html">立即购彩</a></span>
            ...
            <div id="sub-menu-list">
                <div class="cl-600 cl-610 re-cl-610">
                    <div class="cl-602 index-btns">
                        ...
                        <a href="javascript:void(0)" data-index="2">季军</a>
            ...
            <%--<div id="sub-menu-list">--%>
                ...
                <div class="zst-cl-1 zst_style">
                    ...
                    <div class="zst-content zst_relative"></div>
                </div>
            </div>

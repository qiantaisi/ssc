...
<div>
    ...
    <p><strong>◎二字定位</strong></br>于百十个任选二位，自0~9任选2个号进行投注，当开奖结果与所选号码相同且顺序一致时，即为中奖。</br>
...
<div class="help_col">
    ...
    <p>排列三是依照中国体彩管理中心发行的排列三的开奖结果为派彩依据，开奖时间是每天晚上八点，每天开奖一次。假设排列三开奖结果为 123，那么百位是 1，十位是 2，个位是 3。(每个位数在开奖时从 0 ~ 9
        中摇出一个结果)；本公司排列三具体游戏规则请参考彩种介绍。</p>
</div>
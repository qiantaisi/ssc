...
<div class="gfwf-1">
    <div class="gfwf-2">
        ...
        <div class="wfsm-a">
            ...
            <a onclick="javascript:document.getElementById('test7').scrollIntoView()"
               href="javascript:;">七、玩法特点</a></br>
            <b class="inner_href"><i class="_direction" id="test1">&nbsp;</i>
                <p id="1">一、玩法类型及承销</p></b>
            排列三是一种小盘玩法游戏，属数字型彩票范畴，由中国福利彩票发行管理中心统一组织发行，在全国范围内销售<、br>

            <b class="inner_href"><i class="_direction" id="test2">&nbsp;</i>
                <p id="11">二、开奖与购买方式</p></b>
            1.
            本站排列三游戏每天进行1期，每晚20:30现场开奖，开奖号码通过摇奖方式产生，中央广播电台中国之声对开奖进行现场直播。购买者可透过本站进行投注，在对其选定的投注号码进行投注；或返点投注，返点越高投注赔率则低。每注金额人民币1元。
            <br>
            2. 购买者可选择机选号码投注、自选号码投注。机选号码投注是指由投注机随机产生投注号码进行投注，自选号码投注是指将购买者选定的号码输入投注机进行投注。
            <br>
            3.
            购买者还可进行多倍投注、追号投注。多倍投注是指同样的投注号码进行翻倍数额购买的投注。追号投注指将一注或一组号码进行两期或两期以上的投注。追号可分为连续追号和间隔追号，连续追号指追号的期数是连续的，间隔追号指追号的期数不连续。
            <br>
            4. 如果用户投注成功后，若因销售终端故障、通讯线路故障和投注站信用额度受限等原因造成当期无法开奖的，应退还购买者投注金额。
            </br>
            <b class="inner_href"><i class="_direction" id="test3">&nbsp;</i>
                <p id="2">三、兑奖</p></b>
            1. 返奖：无论大小奖均返还至用户在本站的账户中，一旦用户中奖，系统将自动返还中奖金额。可继续投注或提款，永无弃奖。
            </br>
            <b class="inner_href"><i class="_direction" id="test4">&nbsp;</i>
                <p id="3">四、玩法说明</p></b>
            1．排列三投注区分为百位、十位和个位，以一个3位自然数为投注号码的彩种玩法，投注者从000到999的范围内选择一个3位数进行投注，排列三玩法即是竞猜3位开奖号码。
            <div align="center">
                <img src="/help/instructImg.html?img=rule.pls.p1.gif">
            </div>
            <br>
            2. 在本站中，排列三支持的玩法有"排列三分直选"、"组选三"、和"组选六"三种玩法如下：
            <br>
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" class="table-wfsm">
                <tbody>
                <tr align="center" class="cu">
                    <td width="79" height="25" bgcolor="#efefef" class="th-wfsm">玩法</td>
                    <td width="514" height="25" bgcolor="#efefef" class="th-wfsm">规则</td>
                </tr>
                <tr align="center">
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">直选</td>
                    <td width="514" height="25" bgcolor="#FFFFFF" class="td-wfsm">竟猜三位开奖号码，即百位、十位和个位，且顺序一致。</td>
                </tr>
                <tr align="center">
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">组选三</td>
                    <td width="514" height="25" bgcolor="#FFFFFF" class="td-wfsm">
                        竟猜三位开奖号码，即百位、十位和个位，顺序不限，且投注时三位号码有且只有两位相同。
                    </td>
                </tr>
                <tr align="center">
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">组选六</td>
                    <td width="514" height="25" bgcolor="#FFFFFF" class="td-wfsm">
                        竟猜三位开奖号码，即百位、十位和个位，顺序不限，且投注时三位号码各不相同。
                    </td>
                </tr>
                </tbody>
            </table>
            ...
            <br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;3&gt;组选三：在组选中，如果一注组选号码的3个数字有两个数字相同，则有3种不同的排列方式，因而就有3个中奖机会，这种组选投注方式简称组选三。示例：112，排列方式有112、121、211。
            <br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;4&gt;组选六：在组选中，如果一注组选号码的3个数字各不相同，则有6种不同的排列方式，因而就有6个中奖机会，这种组选投注方式简称组选六。示例：123，排列方式有123、132、213、231、312、321，共计6种。
            </br>
            <b class="inner_href"><i class="_direction" id="test5">&nbsp;</i>
                <p id="6">五、设奖及中奖</p></b>
            奖金计算说明列表请浏览本站主页"开奖公告"页面，点击排列三查阅。
            <br>
            ...
            <br>&nbsp;&nbsp;&nbsp;&nbsp;&lt;2&gt;定位和不定位：定位指投注号码与开奖号码按位一致，不定位指投注号码与开奖号码一致，顺序不限。示例：开奖号码为678，678则定位中三码，768或867则为不定位中三码。
            </br>
            <b class="inner_href"><i class="_direction" id="test6">&nbsp;</i>
                <p id="13">六、投注方式</p></b>
            <p>1、直选标准</p>
            对百位、十位和个位各选1个号码为一注，每位号码最多可0～9全选，投注号码与开奖号码顺序一致即为中奖。（每位号码可以同时选择多个进行复式投注）
            <div align="center">
                <img src="/help/instructImg.html?img=rule.pls.p2.gif">
            </div>
            <br>
            <p>2、组三组选</p>
            ...
            <table width="100%" cellspacing="1" cellpadding="0" border="0" bgcolor="#CCCCCC" class="table-wfsm">
                ...
                <tr align="center">
                    ...
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">633.332</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">633.332</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">633.332</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">633.332</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">633.332</td>
            ...
            <div align="center">
                <img src="/help/instructImg.html?img=rule.pls.p3.gif">
            </div>
            <p>4、组六组选</p>
            ...
            <table width="100%" cellspacing="1" cellpadding="0" border="0" bgcolor="#CCCCCC" class="s-table">
                ...
                <tr align="center">
                    ...
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">40</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">70</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">112</td>
                ...
                <tr align="center">
                    <td height="25" bgcolor="#eFeFeF" class="th-wfsm">中奖奖金（元）</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">158.333</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">158.333</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">158.332</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">158.332</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">158.332</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">158.332</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">158.332</td>
            ...
            <div align="center">
                <img src="/help/instructImg.html?img=rule.pls.p4.gif">
            </div>
            <br><br>
            <b class="inner_href"><i class="_direction" id="test7">&nbsp;</i>
                <p id="12">七、玩法特点</p></b>
            <div align="center">
                <img src="/help/instructImg.html?img=rule.pls.jpg">
            </div>
            <div class="gfwf-3">
            <span>

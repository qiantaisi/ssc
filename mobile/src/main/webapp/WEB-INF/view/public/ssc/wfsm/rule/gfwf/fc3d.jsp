...
<div class="gfwf-1">
    <div class="gfwf-2">
        ...
        <div class="wfsm-a">
            ...
            <a onclick="javascript:document.getElementById('test7').scrollIntoView()" href="javascript:;">七、玩法特点</a><br>

            <b class="inner_href"><i class="_direction" id="test1">&nbsp;</i>
                <p id="1">一、玩法类型及承销</p>
            </b>
            福彩3D是一种小盘玩法游戏，属数字型彩票范畴，由中国福利彩票发行管理中心统一组织发行，在全国范围内销售。
            <b class="inner_href"><i class="_direction" id="test2">&nbsp;</i>
                <p id="2">二、开奖与购买方式</p>
            </b>
            1. 本站福彩3D游戏每天进行1期，每晚21:15现场开奖，开奖号码通过摇奖方式产生，中央广播电台中国之声对开奖进行现场直播。购买者可透过本站进行投注，在对其选定的投注号码进行投注；或返点投注，返点越高投注赔率则低。每注金额人民币1元。
            <br>
            2. 购买者可选择机选号码投注、自选号码投注。机选号码投注是指由投注机随机产生投注号码进行投注，自选号码投注是指将购买者选定的号码输入投注机进行投注。
            <br>
            3. 购买者还可进行多倍投注、追号投注。多倍投注是指同样的投注号码进行翻倍数额购买的投注。追号投注指将一注或一组号码进行两期或两期以上的投注。追号可分为连续追号和间隔追号，连续追号指追号的期数是连续的，间隔追号指追号的期数不连续。
            <br>
            ...
            <table width="100%" cellspacing="1" cellpadding="0" border="0" bgcolor="#CCCCCC" class="table-wfsm">
                ...
                <tr align="center">
                    ...
                    <td width="514" height="25" bgcolor="#FFFFFF" class="td-wfsm">竟猜三位开奖号码，即百位、十位和个位，顺序不限，且投注时三位号码有且只有两位相同。</td>
                </tr>
                <tr align="center">
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">组选六</td>
                    <td width="514" height="25" bgcolor="#FFFFFF" class="td-wfsm">竟猜三位开奖号码，即百位、十位和个位，顺序不限，且投注时三位号码各不相同。</td>
                </tr>
                </tbody>
            </table>
            ...
            <table width="100%" cellspacing="1" cellpadding="0" border="0" bgcolor="#CCCCCC" class="table-wfsm">
                ...
                <tr align="center">
                    <td height="25" bgcolor="#eFeFeF" class="td-wfsm">投注金额（2元）</td>
                    <td height="25" bgcolor="#FFFFFF" class="td-wfsm">4</td>
            ...
            <div align="center">
                <img src="/help/instructImg.html?img=rule.fcsd.jpg">
            </div>
            <div class="gfwf-3">
            <span>

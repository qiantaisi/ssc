...
%>
<div>
    <h5><strong>10分六合彩规则说明</strong></h5>
    ...
    <p><strong>7、正码特 ： </strong>正码特是指 正1特、正2特、正3特、正4特、正5特、正6特：其下注的正码特号与现场摇珠开出之正码其开奖顺序及开奖号码相同，视为中奖，
    ...
    <table>
        ...
        <tr>
            ...
            <td width="96%" bgcolor="#FFF7F0">
                ...
                若3个都是开奖号码中的正码，即为三中二之中三，其馀情形视为不中奖，如06、07、08 为一组合，开奖号码中有06、07两个正码，没有08，即为三中二，按三中二赔付；如开奖
    ...
    <p><strong>14、合肖 ：</strong>
        选1~11生肖(排列如同生肖)为一组合，并选择开奖号码的特码是否在此组合内，若选择是"中"(可选择2~11个生肖)且开奖号码的特码亦在此组合内，即视为中奖；若选择否"不中"(可选择1~10个生肖),<span
                style='color:red;font-weight:bold'>系统会将选择不中的组合改为中的组合；</span>若当期特码开出49号，则所有组合皆视为和局</p>
...
<div class="help_col">
    <h5><strong>10分六合彩下注声明</strong></h5>
    ...
    <p><strong>11、</strong>『六合彩』当次确认下注时间与上次确认下注时间10秒钟内：出现同群组且内容相同2笔以上之注单，本公司只承认一笔有效注单，其余一律注销。</br>
        (举例1：十秒内出现快速下注特别号01,02,03同群组同内容的注单两组以上,本公司只保留一组有效,其余将注销)</br>(举例2：十秒内出现快速下注特别号01,02,03

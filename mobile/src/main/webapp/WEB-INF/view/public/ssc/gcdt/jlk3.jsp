...
<div class="page-group">
    <div class="page page-current" id="page-gcdt-jlk3">
        ...
        <div class="content cl-601">
            <div class="cl-600" id="ssc-parent-menu">
                <div class="cl-602">
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/jlk3/hz.html">和值</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/jlk3/tx.html">通选</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/jlk3/sthdx.html">三同号单选</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/jlk3/sbt.html">三不同</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/jlk3/ethfx.html">二同号复选</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/jlk3/ethdx.html">二同号单选</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/jlk3/ebth.html">二不同号</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/jlk3/cbc.html">猜必出</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/jlk3/cbbc.html">猜必不出</a>
                </div>
            </div>
    ...
    <c:import url="../../common/menuAlert.jsp">
        <c:param name="playGroupId" value="21"/>
    </c:import>
</div>

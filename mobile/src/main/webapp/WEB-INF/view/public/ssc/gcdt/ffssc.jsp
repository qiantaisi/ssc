...
<div class="page-group">
    <div class="page page-current" id="page-gcdt-ffssc">
        <header class="bar bar-nav">
            ...
            <h1 class="title">
                <a class="title_cq" href="<%=basePath%>ssc/gcdt/gfwf/ffssc.html">分分时时彩-传统模式
        ...
        <%--<div class="BeginFind Hide_Show">--%>
            <%--<div class="gfwf_consele">--%>
                <%--<div class="gfwf_one">--%>
                    <%--<a class="F1_color" href="<%=basePath%>ssc/gcdt/gfwf/ffssc.html">--%>
                ...
                <%--</div>--%>
                <%--<div class="gfwf_two">--%>
                    <%--<a class="F2_color" href="<%=basePath%>ssc/gcdt/ffssc.html">--%>

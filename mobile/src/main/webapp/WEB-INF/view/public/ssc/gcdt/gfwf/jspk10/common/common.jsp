    ...
    <div class="staer wx-select restaer">
        <div class="hide" id="playGroup_qy">
            <a href="javascript:void(0)"
               ...
               data-url="<%=basePath%>ssc/gcdt/gfwf/jspk10/qy/qy.html"
               data-play_id="666"
               data-play_pl_id="14415"
               data-name="直选复式">
        ...
        <div class="hide" id="playGroup_dwd">
            <a href="javascript:void(0)"
               ...
               data-url="<%=basePath%>ssc/gcdt/gfwf/jspk10/dwd/dwd.html"
               data-play_id="672"
               data-play_pl_id="14421"
               data-name="定位胆">
        ...
        <div class="hide" id="playGroup_qe">
            <a href="javascript:void(0)"
               ...
               data-url="<%=basePath%>ssc/gcdt/gfwf/jspk10/qe/qe.html"
               data-play_id="668"
               data-play_pl_id="14417"
               data-name="直选复式">
                <span class="staer1">直选复式</span>
            </a>
        </div>
        <div class="hide" id="playGroup_qsan">
            <a href="javascript:void(0)"
               ...
               data-url="<%=basePath%>ssc/gcdt/gfwf/jspk10/qsan/qsan.html"
               data-play_id="670"
               data-play_pl_id="14419"
               data-name="直选复式">
                <span class="staer1">直选复式</span>
            </a>
        </div>

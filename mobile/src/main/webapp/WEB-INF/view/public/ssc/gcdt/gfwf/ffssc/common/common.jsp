    ...
    <div class="staer wx-select restaer">
        ...
        <div class="hide" id="playGroup_q3">
            ...
            <a href="javascript:void(0)"
               ...
               data-play_id="636"
               data-play_pl_id="14365|14364|14363"
               data-name="前三组合">
            ...
            <a href="javascript:void(0)"
               ...
               data-play_id="625"
               data-play_pl_id="14349|14348|14347"
               data-name="特殊号">
                <span class="staer1">特殊号</span>
            </a>
        </div>

        ...
        <div class="content cl-601 zst-cl-10">
            <div class="cl-600" id="ssc-parent-menu">
                <div class="re-cl-602">
                    ...
                    <span class="goucai"><a id="blink" href="<%=basePath%>ssc/gcdt/tjssc.html">立即购彩</a></span>
            ...
            <%--<div class="cl-600" id="ssc-parent-menu">--%>
                <%--<div class="cl-602 index-btns">--%>
                    <%--<a href="javascript:void(0)" data-index="0" class="active">万位</a>--%>
                    <%--<a href="javascript:void(0)" data-index="1">千位</a>--%>
                    <%--<a href="javascript:void(0)" data-index="2">百位</a>--%>
                    <%--<a href="javascript:void(0)" data-index="3">十位</a>--%>
                    <%--<a href="javascript:void(0)" data-index="4">个位</a>--%>
...
<script>
    ...
    function renderData(data) {
        ...
        for (var ii = 0; ii < data.length; ii++) {
            ...
            htmlCanvas = '<canvas class="mobile_zx" id="canvas' + ii + '' + dataIndex + '" width="' + bc1 + 'px" height="' + spanH + 'px" style="z-index: 100!important; left:' + left_w + 'px; display: inline;"></canvas>';
        ...
        for (var m = 0; m < data.length - 1; m++) {
            var location_x = spanW;
            var location_y = spanH;
            //设置canvas定位

...
<div class="page-group">
    <div class="page page-current" id="page-gcdt-xjssc-gfwf">
        <header class="bar bar-nav">
            ...
            <h1 class="title">
                <a class="title_cq" href="<%=basePath%>ssc/gcdt/xjssc.html">新疆时时彩-官方模式
        ...
        <%--<div class="BeginFind Hide_Show">--%>
            <%--<div class="gfwf_consele">--%>
                <%--<div class="gfwf_one">--%>
                    <%--<a class="F2_color" href="<%=basePath%>ssc/gcdt/gfwf/xjssc.html">--%>
                ...
                <%--</div>--%>
                <%--<div class="gfwf_two">--%>
                    <%--<a class="F1_color" href="<%=basePath%>ssc/gcdt/xjssc.html">--%>
        ...
        <div class="content cl-601">
            <c:import url="./xjssc/common/common.jsp"/> <%--玩法选择菜单标题--%>

...
<div class="page-group">
    <div class="page page-current" id="page-gcdt-cqssc">
        <header class="bar bar-nav">
            ...
            <h1 class="title">
                <a class="title_cq" href="<%=basePath%>ssc/gcdt/gfwf/cqssc.html">重庆时时彩-传统模式
        ...
        <div class="content cl-601">
            ...
            <div id="sub-menu-list">
                <div class="cl-600 cl-610 hide" id="sub-menu-yzdw">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/yzdw_wdw.html">万定位</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/yzdw_qdw.html" href="javascript:void(0)">千定位</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/yzdw_bdw.html" href="javascript:void(0)">百定位</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/yzdw_sdw.html" href="javascript:void(0)">十定位</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/yzdw_gdw.html" href="javascript:void(0)">个定位</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-yzzh">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/yzzh_qw.html">全五一字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/yzzh_qs.html">前三一字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/yzzh_zs.html">中三一字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/yzzh_hs.html">后三一字组合</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-ezzh">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/ezzh_qs.html">前三二字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/ezzh_zs.html">中三二字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/ezzh_hs.html">后三二字组合</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-zxs">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/zxs_qs.html">前三组选三</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/zxs_zs.html">中三组选三</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/zxs_hs.html">后三组选三</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-zxl">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/zxl_qs.html">前三组选六</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/zxl_zs.html">中三组选六</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/zxl_hs.html">后三组选六</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-kd">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/kd_qs.html">前三跨度</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/kd_zs.html">中三跨度</a>
                        <a data-url="<%=basePath%>ssc/gcdt/cqssc/kd_hs.html">后三跨度</a>
                    </div>
                </div>
            </div>

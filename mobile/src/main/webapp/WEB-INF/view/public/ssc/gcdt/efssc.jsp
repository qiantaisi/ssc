...
<div class="page-group">
    <div class="page page-current" id="page-gcdt-efssc">
        <header class="bar bar-nav">
            ...
            <h1 class="title">
                <a class="title_cq" href="<%=basePath%>ssc/gcdt/gfwf/efssc.html">二分时时彩-传统模式
        ...
        <%--<div class="BeginFind Hide_Show">--%>
            <%--<div class="gfwf_consele">--%>
                <%--<div class="gfwf_one">--%>
                    <%--<a class="F1_color" href="<%=basePath%>ssc/gcdt/gfwf/efssc.html">--%>
                ...
                <%--</div>--%>
                <%--<div class="gfwf_two">--%>
                    <%--<a class="F2_color" href="<%=basePath%>ssc/gcdt/efssc.html">--%>
        ...
        <div class="content cl-601">
            <div class="cl-600" id="ssc-parent-menu">
                <div class="cl-602">
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/efssc/sm.html">双面</a>
                    <a href="javascript:void(0)" data-type="page"
                       data-url="<%=basePath%>ssc/gcdt/efssc/szp.html">数字盘</a>
                    <a href="javascript:void(0)" data-type="sub-menu" data-sub_menu_id="sub-menu-yzdw">一字定</a>
                    <a href="javascript:void(0)" data-type="page"
                       data-url="<%=basePath%>ssc/gcdt/efssc/ezdw.html">二字定</a>
                    <a href="javascript:void(0)" data-type="page"
                       data-url="<%=basePath%>ssc/gcdt/efssc/szdw.html">三字定</a>
                    ...
                    <a href="javascript:void(0)" data-type="page"
                       data-url="<%=basePath%>ssc/gcdt/efssc/ezhs.html">二字和</a>
                    ...
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/efssc/lh.html">龙虎</a>
                </div>
            </div>
            ...
            <div id="sub-menu-list">
                <div class="cl-600 cl-610 hide" id="sub-menu-yzdw">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/yzdw_wdw.html">万定位</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/yzdw_qdw.html" href="javascript:void(0)">千定位</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/yzdw_bdw.html" href="javascript:void(0)">百定位</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/yzdw_sdw.html" href="javascript:void(0)">十定位</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/yzdw_gdw.html" href="javascript:void(0)">个定位</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-yzzh">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/yzzh_qw.html">全五一字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/yzzh_qs.html">前三一字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/yzzh_zs.html">中三一字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/yzzh_hs.html">后三一字组合</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-ezzh">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/ezzh_qs.html">前三二字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/ezzh_zs.html">中三二字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/ezzh_hs.html">后三二字组合</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-zxs">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/zxs_qs.html">前三组选三</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/zxs_zs.html">中三组选三</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/zxs_hs.html">后三组选三</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-zxl">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/zxl_qs.html">前三组选六</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/zxl_zs.html">中三组选六</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/zxl_hs.html">后三组选六</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-kd">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/kd_qs.html">前三跨度</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/kd_zs.html">中三跨度</a>
                        <a data-url="<%=basePath%>ssc/gcdt/efssc/kd_hs.html">后三跨度</a>
                    </div>
                </div>
            </div>

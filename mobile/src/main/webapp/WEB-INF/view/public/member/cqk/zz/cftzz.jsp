...
<div class="page-group">
    <div class="page page-current" id="page-cqk-zz-cftzz">
        ...
        <div class="content cl-700">
            <div class="list-block cl-708">
                ...
                <ul>
                    <li>
                        <div class="item-content">
                            <div class="item-inner">
                                <div class="item-input">
                                    <input type="text" placeholder="请输入财付通昵称" id="name" name="name"/>
                                </div>
                            </div>
                        </div>
                    </li>
                ...
                <div class="cl-303">财付通信息</div>
                <ul>
                    <li>
                        <div class="item-content item-link">
                            <div class="item-inner">
                                <div class="item-input">
                                    <input type="text" placeholder="请选择财付通账号" id="inputSkInfo" readonly>
                                </div>
                            </div>
                        </div>
                    </li>

                    ...
                    <ul>
                            ...
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-input">
                                        <input type="password" placeholder="登录密码" name='oldPassword'>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    <div class="item-title label">新取款密码：</div>
                                    <div class="item-input">
                                        <input type="password" placeholder="新取款密码" name='newPassword'>
                                    </div>
                                </div>
                            </div>
                        </li>
                    ...
                    <ul>
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    <div class="item-title label">确认取款密码：</div>
                                    <div class="item-input">
                                        <input type="password" placeholder="确认取款密码" name='confirmPassword'>
                                    </div>
                                </div>
                            </div>
                        </li>

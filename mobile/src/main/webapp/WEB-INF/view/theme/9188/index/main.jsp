...
<%
    ...
    String pcHostName = RequestUtils.getScheme(request) + "://" + "www." + request.getServerName().replace("m.", "").replace("www.", "").replace("ios.", "").replace("app.", "");
%>
    ...
    <div class="page page-current" id="page-index">
        ...
        <div class="content content-img">
            ...
            <div class="cl-7">
                ...
                <div class="row cl-5">
                    <a class="col-25" href="<%=basePath%>ssc/gcdt/bj28.html">
                        <span class="bg-img-bj28"></span>
                        <span>北京28</span>
                    </a>

                    ...
                    <ul>
                                ...
                                <div class="item-after">
                                    <c:choose>
                                        <c:when test="${data.zjMoney > 0}">
                                            <font color="green">${data.zjMoney}</font>
                                        </c:when>
                                        <c:otherwise>
                                            ${data.zjMoney}
                                        </c:otherwise>
                            ...
                            <div class="item-inner">
                                ...
                                <div class="item-after">
                                    <c:choose>
                                        ...
                                        <c:when test="${data.zjMoney > 0}">
                                            <c:choose>
                                                <c:when test="${data.zjMoney == data.totalMoney}">
                                                    <font>和局</font>
                                                </c:when>
                                                <c:otherwise>
                        ...
                        <li class="item-content">
                            <div class="item-inner">
                                ...
                                <div class="item-after">
                                    <c:choose>
                                        <c:when test="${data.winOrLose > 0}">
                                            <font color="green">${data.winOrLose}</font>
                                        </c:when>
                                        <c:when test="${data.winOrLose < 0}">
                                            <font color="red">${data.winOrLose}</font>
                                        </c:when>
                                        <c:otherwise>
                                            ${data.winOrLose}
                                        </c:otherwise>

                        ...
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-input">
                                        <c:if test="${empty userSession.telephone}">
                                            <input type="text" value="${userSession.telephone}"  name="telephone" />
                                        </c:if>
                                        <c:if test="${not empty userSession.telephone}">
                                            <label style="margin-left: 15px;color: #999;">${userSession.telephone}</label>
                                        </c:if>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-input">
                                        <c:if test="${empty userSession.email}">
                                          <input type="text" value="${userSession.email}" name="email"  />
                                        </c:if>
                                        <c:if test="${not empty userSession.email}">
                                            <label style="margin-left: 15px;color: #999;">${userSession.email}</label>
                                        </c:if>
                                    </div>
                                </div>
                            </div>

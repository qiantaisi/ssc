...
<input type="hidden" data-plid="7591" id="pl4"></input>
<input type="hidden" data-plid="7600" id="pl5"></input>
<input type="hidden" data-plid="7609" id="pl6"></input>
<input type="hidden" data-plid="7618" id="pl7"></input>
<input type="hidden" data-plid="7627" id="pl8"></input>
<script>
    var playGroupId = 3;
    var playId = 249;

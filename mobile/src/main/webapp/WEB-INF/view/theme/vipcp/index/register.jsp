        ...
        <div class="content bg-white">
            <div class="cl-101">
                <div class="list-block">
                    <ul>
                        <span class="settings">字母开头的6-12位字母数字组成的用户名</span>
                        <li>
                    ...
                    <ul>
                        <span class="settings">请输入6-12位字母、数字的密码</span>
                        <li>
                            <div class="item-content">
                    ...
                    <ul>
                        <span class="settings">请再次输入您的密码</span>
                        <li>
                            <div class="item-content">
                                <div class="item-media"><i class="icon icon-form-password"></i></div>
                                <div class="item-inner">
                    ...
                    <ul>
                        <span class="settings">请输入真实姓名</span>
                        <li>
                            <div class="item-content">
                                <div class="item-media"><i class="icon icon-form-password"></i></div>
                                <div class="item-inner">
            ...
            <div class="cl-102">
                <a href="javascript:void(0)" class="cl-103" id="btn-register">注册</a>
            </div>
            <div class="cl-103">
                <span>已有账号？</span>

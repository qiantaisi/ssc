        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('sfssc-zxl_q3')">前三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sfssc-zxl_z3')" class="active">中三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sfssc-zxl_h3')">后三组选六</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="10296" id="pl4"/>
<input type="hidden" data-plid="10295" id="pl5"/>
<input type="hidden" data-plid="10294" id="pl6"/>
<input type="hidden" data-plid="10293" id="pl7"/>
<input type="hidden" data-plid="10292" id="pl8"/>

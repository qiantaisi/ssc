        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix"  style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-zxl_q3')">前三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-zxl_z3')" class="active">中三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-zxl_h3')">后三组选六</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="7592" id="pl4"/>
<input type="hidden" data-plid="7601" id="pl5">
<input type="hidden" data-plid="7610" id="pl6"/>
<input type="hidden" data-plid="7619" id="pl7"/>
<input type="hidden" data-plid="7628" id="pl8"/>
<script>
    var playGroupId = 3;
    var playId = 249;

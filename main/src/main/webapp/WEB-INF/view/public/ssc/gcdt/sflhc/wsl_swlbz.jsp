        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-wsl_ewlz')">二尾连中</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-wsl_swlz')">三尾连中</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-wsl_siwlz')">四尾连中</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-wsl_ewlbz')">二尾连不中</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-wsl_swlbz')" class="active">三尾连不中</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-wsl_siwlbz')">四尾连不中</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="13945"></strong></td>
                    <td><input type="checkbox" data-name="1" data-plid="13945"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="13950"></strong></td>
                    <td><input type="checkbox" data-name="6" data-plid="13950"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="13946"></strong></td>
                    <td><input type="checkbox" data-name="2" data-plid="13946"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="13951"></strong></td>
                    <td><input type="checkbox" data-name="7" data-plid="13951"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="13947"></strong></td>
                    <td><input type="checkbox" data-name="3" data-plid="13947"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="13952"></strong></td>
                    <td><input type="checkbox" data-name="8" data-plid="13952"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="13948"></strong></td>
                    <td><input type="checkbox" data-name="4" data-plid="13948"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="13953"></strong></td>
                    <td><input type="checkbox" data-name="9" data-plid="13953"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="13949"></strong></td>
                    <td><input type="checkbox" data-name="5" data-plid="13949"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="13944"></strong></td>
                    <td><input type="checkbox" data-name="0" data-plid="13944"/></td>
                    <td>
...
<input type="hidden" data-plid="6802" id="pl"/>
<script>
    var playGroupId = 22;
    var playId = 481;
    ...
    function getZhudan() {
        ...
        $.each(tmpArr, function (index, value) {
            betForm.sscBetList.push({
                ...
                zhushu: 1,
                perMoney: inputMoney,
                content: '三尾连不中-' + value.split(" ").join(","),
                playPlId: minPlId,
                playPl: minPl
            });

        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix"  style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('cqssc-zxl_h3')" class="active">后三组选六</a>
                </div>
            </div>
        </div>
...
<%-- 后三组选六 --%>
<input type="hidden" data-plid="7587" id="pl4"/>
<input type="hidden" data-plid="7596" id="pl5"/>
<input type="hidden" data-plid="7605" id="pl6"/>
<input type="hidden" data-plid="7614" id="pl7"/>
<input type="hidden" data-plid="7623" id="pl8"/>
<script>
    var playGroupId = 1;
    var playId = 225;

        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix"  style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-zxs_q3')">前三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-zxs_z3')" class="active">中三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-zxs_h3')">后三组选三</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="7538" id="pl5"/>
<input type="hidden" data-plid="7547" id="pl6"/>
<input type="hidden" data-plid="7556" id="pl7"/>
<input type="hidden" data-plid="7565" id="pl8"/>
<input type="hidden" data-plid="7574" id="pl9"/>
<input type="hidden" data-plid="7583" id="pl10"/>
<script>
    var playGroupId = 3;
    var playId = 248;

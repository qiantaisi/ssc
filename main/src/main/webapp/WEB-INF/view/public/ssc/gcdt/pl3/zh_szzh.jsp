    ...
    <div class="fl main-left">
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('pl3-zh_szzh')" class="active">三字组合</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                <thead>
                <tr>
                    <th colspan="20">三字组合（三字@<span class="pl red" data-plid="7942"></span>组三@<span class="pl red"
                                                                                                   data-plid="7943"></span>
                        组六@<span class="pl red" data-plid="7944"></span>)
                    </th>
                </tr>
                <tr>
...
<input type="hidden" data-plid="7942" id="sz"/>
<input type="hidden" data-plid="7943" id="zs"/>
<input type="hidden" data-plid="7944" id="zl"/>

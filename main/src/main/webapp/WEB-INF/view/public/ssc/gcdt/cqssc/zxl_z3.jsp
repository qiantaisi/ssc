        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix"  style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('cqssc-zxl_q3')">前三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('cqssc-zxl_z3')" class="active">中三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('cqssc-zxl_h3')">后三组选六</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="7586" id="pl4"/>
<input type="hidden" data-plid="7595" id="pl5"/>
<input type="hidden" data-plid="7604" id="pl6"/>
<input type="hidden" data-plid="7613" id="pl7"/>
<input type="hidden" data-plid="7622" id="pl8"/>

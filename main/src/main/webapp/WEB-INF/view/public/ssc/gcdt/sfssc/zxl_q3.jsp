        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('sfssc-zxl_q3')" class="active">前三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sfssc-zxl_z3')">中三组选六</a>
...
<%-- 前三组选六 --%>
<input type="hidden" data-plid="10301" id="pl4"/>
<input type="hidden" data-plid="10300" id="pl5"/>
<input type="hidden" data-plid="10299" id="pl6"/>
<input type="hidden" data-plid="10298" id="pl7"/>
<input type="hidden" data-plid="10297" id="pl8"/>
<script>
    var playGroupId = 13;
    var playId = 335;

        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('wfssc-zxl_z3')" class="active">中三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('wfssc-zxl_h3')">后三组选六</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="11485" id="pl4"/>
<input type="hidden" data-plid="11484" id="pl5"/>
<input type="hidden" data-plid="11483" id="pl6"/>
<input type="hidden" data-plid="11482" id="pl7"/>
<input type="hidden" data-plid="11481" id="pl8"/>

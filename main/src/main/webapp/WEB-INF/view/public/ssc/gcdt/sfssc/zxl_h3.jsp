        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('sfssc-zxl_h3')" class="active">后三组选六</a>
                </div>
            </div>
        </div>
...
<%-- 后三组选六 --%>
<input type="hidden" data-plid="10291" id="pl4"/>
<input type="hidden" data-plid="10290" id="pl5"/>
<input type="hidden" data-plid="10289" id="pl6"/>
<input type="hidden" data-plid="10288" id="pl7"/>
<input type="hidden" data-plid="10287" id="pl8"/>
<script>
    var playGroupId = 13;
    var playId = 335;

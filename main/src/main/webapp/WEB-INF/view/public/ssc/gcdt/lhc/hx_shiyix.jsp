        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('lhc-hx_ex')">二肖</a>
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('lhc-hx_shiyix')" class="active">十一肖</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6790"></strong></td>
...
<input type="hidden" data-plid="6790" id="pl"/>
<script>
    var playGroupId = 6;
    var playId = 212;

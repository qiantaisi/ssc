        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-hx_wx')" class="active">五肖</a>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="13873"></strong></td>
...
<input type="hidden" data-plid="13873" id="pl"/>
<script>
    var playGroupId = 22;
    var playId = 476;

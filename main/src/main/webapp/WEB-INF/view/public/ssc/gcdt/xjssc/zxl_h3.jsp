        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix"  style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-zxl_h3')" class="active">后三组选六</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="7593" id="pl4"/>
<input type="hidden" data-plid="7602" id="pl5"/>
<input type="hidden" data-plid="7611" id="pl6"/>
<input type="hidden" data-plid="7620" id="pl7"/>
<input type="hidden" data-plid="7629" id="pl8"/>

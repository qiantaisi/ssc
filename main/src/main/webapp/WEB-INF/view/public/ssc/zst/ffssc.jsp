    ...
    <div class="qc" id="Right">
        <div class="main">
            <div class="main-box remain-box">
                <div class="main-nav">
                    <div class="cplogo"><img src="${resPath}zst/img/ffssc.png" alt="分分时时彩" /><span>分分时时彩</span></div>
                    ...
                    <ul class="btn-navs">
                        ...
                        <li>
                            <a href="javascript:void(0)" onclick="parent.getSscPage('gcdt/ffssc')">立即投注</a>
                        </li>
                    </ul>
                </div>
                <div class="qhbox">
                    ...
                    <div class="shuoming qc">
                        ...
                        <div class="shuomingright" style="width:500px;">
                            ...
                            <a href="javascript:void(0)" onclick="getSscPage('gcdt/ffssc')"><img class="btnjiang" src="${resPath}zst/img/jiang.png" alt=""></a>
                            <div class="jiezhi">
                                <h3>
                                    <p><font id="tip"></font>

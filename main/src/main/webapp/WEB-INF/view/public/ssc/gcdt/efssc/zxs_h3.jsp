        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('efssc-zxs_z3')">中三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('efssc-zxs_h3')" class="active">后三组选三</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="11131" id="pl5"/>
<input type="hidden" data-plid="11130" id="pl6"/>
<input type="hidden" data-plid="11129" id="pl7"/>
<input type="hidden" data-plid="11128" id="pl8"/>
<input type="hidden" data-plid="11127" id="pl9"/>
<input type="hidden" data-plid="11126" id="pl10"/>

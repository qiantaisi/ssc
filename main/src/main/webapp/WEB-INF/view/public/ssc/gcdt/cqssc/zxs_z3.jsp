        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix"  style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('cqssc-zxs_q3')">前三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('cqssc-zxs_z3')" class="active">中三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('cqssc-zxs_h3')">后三组选三</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="7532" id="pl5"/>
<input type="hidden" data-plid="7541" id="pl6"/>
<input type="hidden" data-plid="7550" id="pl7"/>
<input type="hidden" data-plid="7559" id="pl8"/>
<input type="hidden" data-plid="7568" id="pl9"/>
<input type="hidden" data-plid="7577" id="pl10"/>
<script>
    var playGroupId = 1;
    var playId = 224;

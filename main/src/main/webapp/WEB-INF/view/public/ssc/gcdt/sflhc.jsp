            ...
            <div class="Playmethod">
                <ul>
                    <li>
                        <b>快钱玩法</b>
                        <p>
                            <span><a href="javascript:void(0)" data-url="sflhc-tm_b">特码</a></span>
                            <span><a href="javascript:void(0)" data-url="sflhc-zm_b">正码</a></span>
                            <span><a href="javascript:void(0)" data-url="sflhc-ztm_zyt">正特码</a></span>
                            <span><a href="javascript:void(0)" data-url="sflhc-zm_16">正码1-6</a></span>
                            <span><a href="javascript:void(0)" data-url="sflhc-lm_sqz">连码</a></span>
                            <span><a href="javascript:void(0)" data-url="sflhc-banbo">半波</a></span>
                            <span><a href="javascript:void(0)" data-url="sflhc-yixiao">一肖/尾</a></span>
                            <span><a href="javascript:void(0)" data-url="sflhc-tmsx">特肖</a></span>
                            <span><a href="javascript:void(0)" data-url="sflhc-hx_ex">合肖</a></span>
                            <span><a href="javascript:void(0)" data-url="sflhc-lx_exlz">连肖</a></span>
                            <span><a href="javascript:void(0)" data-url="sflhc-wsl_ewlz">尾数连</a></span>
                            <span><a href="javascript:void(0)" data-url="sflhc-qbz_wbz">全不中</a></span>
                        </p>
                    </li>
                </ul>
            </div>

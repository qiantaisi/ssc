    ...
    <div class="qc" id="Right">
        <div class="main">
            <div class="main-box" style="width:2402px;">
                <div class="main-nav">
                    <div class="cplogo"><img src="${resPath}zst/img/xyft.png" alt="幸运飞艇" /><span>幸运飞艇</span></div>
                    ...
                    <ul class="btn-navs">
                        ...
                        <li>
                            <a href="javascript:void(0)" onclick="getSscPage('gcdt/xyft')">立即投注</a>
                        </li>
                    </ul>
                </div>
                <div class="qhbox">
                    ...
                    <div class="shuoming qc">
                        ...
                        <div class="shuomingright" style="width:500px;">
                            ...
                            <a href="javascript:void(0)" onclick="getSscPage('gcdt/xyft')"><img class="btnjiang" src="${resPath}zst/img/jiang.png" alt=""></a>
                            <div class="jiezhi">
                                <h3>
                                    <p><font id="tip"></font>

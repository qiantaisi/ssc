        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-hx_ex')">二肖</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-hx_sx')">三肖</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-hx_six')">四肖</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-hx_wx')">五肖</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-hx_lx')">六肖</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-hx_qx')">七肖</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-hx_bx')">八肖</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-hx_jx')">九肖</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-hx_shix')">十肖</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-hx_shiyix')" class="active">十一肖</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="13879"></strong></td>
...
<input type="hidden" data-plid="13879" id="pl"/>
<script>
    var playGroupId = 22;
    var playId = 476;

...
<div class="zs_list">
    ...
    <ul>
        ...
        <li>
            ...
            <div class="p-url fl">
                <h3>广东11选5</h3>
                <a href="javascript:void(0)" onclick="goZst('<%=basePath%>ssc/zst/gd11x5.html?type=1')">基本走势</a>
                <a href="javascript:void(0)" onclick="goZst('<%=basePath%>ssc/zst/gd11x5.html?type=2')">K线图</a>
                <a href="javascript:void(0)" onclick="goZst('<%=basePath%>ssc/zst/gd11x5.html?type=3')">直方图</a>
                <a href="javascript:void(0)" onclick="goZst('<%=basePath%>ssc/zst/gd11x5.html?type=4')">统计遗漏</a>

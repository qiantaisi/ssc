    ...
    <div class="cl-200 recl-200 ssq_shuom">
        ...
        <span class="fr fl cl-1001">
            ...
            <a>
                ...
                <var>开奖号码：红球 03 04 05 01 06 (顺序不限) 篮球 07 投注方案：01 03 04 05 06：07(一等奖) 01 03 04 05：07或01 03 04 05 06：08 (二等奖) 01 03 04 05：08或01 03 04：07(三等奖) 04 05：07或05：07或09：07(四等奖) 即为中奖。</var>
            </a>
            <a>
                <img src="${resPath}img/ico61.png" alt="">中奖说明
                <var>从1~33红球至少选5个,1~16篮球选1个构成一注。一等奖：中5个红球和1个蓝球，顺序不限；二等奖：中4个红球1个蓝球或者5个红球，顺序不限；三等奖：中3个红球1个蓝球或4个红球，顺序不限；四等奖：中2个红球1个蓝球或1个红球1个蓝球或者1个蓝球，即中奖，顺序不限。</var>
            </a>
        </span>
        </p>
        <ul>
    ...
    <div class="Pick cl-1003 recl-1003" data-flag="dan">
        ...
        <span class="fr fl cl-1001">
            ...
            <a><img src="${resPath}img/ico60.png" alt="">选号规则
                <var>投注方案：红球：01 03 04 05 06 蓝球07<br> 开奖号码：蓝球07 红球： 03 04 05 01 06顺序不限即中双色球。</var>
            </a>
            <a>
                <img src="${resPath}img/ico61.png" alt="">中奖说明
                <var>手动输入5个红色求和一个蓝色球组成一注，输入的红球和蓝球号码与开奖号码相同（顺序不限）即为中奖</var>
            </a>
        </span>
        </p>

        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix"  style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('cqssc-zxl_q3')" class="active">前三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('cqssc-zxl_z3')">中三组选六</a>
...
<%-- 前三组选六 --%>
<input type="hidden" data-plid="7585" id="pl4"/>
<input type="hidden" data-plid="7594" id="pl5"/>
<input type="hidden" data-plid="7603" id="pl6"/>
<input type="hidden" data-plid="7612" id="pl7"/>
<input type="hidden" data-plid="7621" id="pl8"/>
<script>
    var playGroupId = 1;
    var playId = 225;

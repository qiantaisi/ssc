    ...
    <div class="qc" id="Right">
        <div class="main">
            <div class="main-box remain-box">
                <div class="main-nav">
                    <div class="cplogo"><img src="${resPath}zst/img/xjssc.png" alt="新疆时时彩" /><span>新疆时时彩</span></div>
                ...
                <div class="qhbox">
                    ...
                    <div class="shuoming qc">
                        ...
                        <div class="shuomingright" style="width:500px;">
                            ...
                            <a href="javascript:void(0)" onclick="getSscPage('gcdt/xjssc')"><img class="btnjiang" src="${resPath}zst/img/jiang.png" alt=""></a>
                            <div class="jiezhi">
                                <h3>
                                    <p><font id="tip"></font>

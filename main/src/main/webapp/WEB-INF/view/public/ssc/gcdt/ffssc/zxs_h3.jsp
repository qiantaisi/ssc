        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('ffssc-zxs_z3')">中三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('ffssc-zxs_h3')" class="active">后三组选三</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="10799" id="pl5"/>
<input type="hidden" data-plid="10798" id="pl6"/>
<input type="hidden" data-plid="10797" id="pl7"/>
<input type="hidden" data-plid="10796" id="pl8"/>
<input type="hidden" data-plid="10795" id="pl9"/>
<input type="hidden" data-plid="10794" id="pl10"/>

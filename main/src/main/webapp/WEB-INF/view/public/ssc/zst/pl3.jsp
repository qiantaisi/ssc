    ...
    <div class="qc" id="Right">
        <div class="main">
            <div class="main-box" style="width:1162px;">
                <div class="main-nav">
                    <div class="cplogo"><img src="${resPath}zst/img/tcpl3.png" alt="体彩排列3" /><span>体彩排列3</span></div>
                    ...
                    <ul class="btn-navs">
                        ...
                        <li>
                            <a href="javascript:void(0)" onclick="getSscPage('gcdt/pl3')">立即投注</a>
                        </li>
                    </ul>
                </div>
                <div class="qhbox">
                    <div class="main-li" style="display: none">
                        ...
                        <div class="main-ul-box2">
                            ...
                            <%--<p>三星:</p>--%>
                            <%--<ul class="main-ul-1">--%>
                            <%--<li><a href="javascript:void(0)">号码分布</a></li>--%>
                            <%--<li><a href="javascript:void(0)">直选</a></li>--%>
                            <%--<li><a href="javascript:void(0)">组选</a></li>--%>
                            <%--<li><a href="javascript:void(0)">大小</a></li>--%>
                            <%--<li><a href="javascript:void(0)">奇偶</a></li>--%>
                            <%--<li><a href="javascript:void(0)">质合</a></li>--%>
                            <%--<li><a href="javascript:void(0)">跨度</a></li>--%>
                            <%--<li><a href="javascript:void(0)">和值</a></li>--%>
                            <%--<li><a href="javascript:void(0)">012路</a></li>--%>
                            <%--<li><a href="javascript:void(0)">平均值</a></li>--%>
                            <%--<li><a href="javascript:void(0)">生平降</a></li>--%>
                            <%--</ul>--%>
                            <%--</li>--%>
                            <%--</ul>--%>
                            <%--<ul class="main-ul-box">--%>
                            ...
                            <%--<p>其他:</p>--%>
                            <%--<ul class="main-ul-1">--%>
                            <%--<li class="red"><a href="javascript:void(0)">五星走势</a></li>--%>
                            <%--<li><a href="javascript:void(0)">五星综合</a></li>--%>
                            <%--<li><a href="javascript:void(0)">大小单双</a></li>--%>
                            <%--</ul>--%>
                            <%--</li>--%>
                            <%--</ul>--%>
                        </div>
                    ...
                    <div class="shuoming qc">
                        <div class="shuomingleft">
                            ...
                            <div class="jieshi">
                                <p><b>组三：</b> 三个号码中有两个号码为三组。</p>
                                <p><b>组六：</b> 三个号码均不相同为组六号。</p>
                                <p><b>豹子：</b> 三个号码相同为豹子号。</p>
                                <%--<p><b>遗漏分层：</b> 将当前遗漏按照“1-5,6-11,12无穷大”分别用黑色、红色、蓝色标示。</p>--%>
                            </div>
                        </div>
                        <div class="shuomingright" style="width:500px;">
                            ...
                            <a href="javascript:void(0)" onclick="getSscPage('gcdt/pl3')"><img class="btnjiang" src="${resPath}zst/img/jiang.png" alt=""></a>
                            <div class="jiezhi">
                                <h3>
                                    <p>
                                        <font id="tip"></font>

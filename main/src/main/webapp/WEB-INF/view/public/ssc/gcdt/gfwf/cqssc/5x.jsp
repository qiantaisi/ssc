...
<%--<div class="add_spot">--%>
    <%--<div class="left releft">--%>
        <%--<div class="sopt_wrap">--%>
            <%--<div class="slide_sp">--%>
                <%--奖金/返点--%>
                <%--&lt;%&ndash;<p><span style="width: 4.89063px;"></span><var style="left: 4.89063px;"></var></p>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<i><var>934058.63</var> / 7.0%</i>&ndash;%&gt;--%>
                <%--<div class="cl-1003">--%>
                    <%--<div class="cl-1004">--%>
                        <%--<input type="hidden" class="slider-input"/>--%>
                    <%--</div>--%>
                <%--</div>--%>
                <%--<i><var class="jiangjin-change">0</var><var>&nbsp;/&nbsp;</var><var class="fandian-bfb">0%</var></i>--%>
            <%--</div>--%>
            <%--<div class="reduce">--%>
                <%--<a class="fl">-</a>--%>

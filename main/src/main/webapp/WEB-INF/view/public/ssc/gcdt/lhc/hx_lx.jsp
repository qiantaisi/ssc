        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('lhc-hx_lx')" class="active">六肖</a>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6785"></strong></td>
...
<input type="hidden" data-plid="6785" id="pl"/>
<script>
    var playGroupId = 6;
    var playId = 212;

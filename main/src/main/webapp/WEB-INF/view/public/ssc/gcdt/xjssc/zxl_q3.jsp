        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix"  style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-zxl_q3')" class="active">前三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-zxl_z3')">中三组选六</a>
...
<input type="hidden" data-plid="7591" id="pl4">
<input type="hidden" data-plid="7600" id="pl5">
<input type="hidden" data-plid="7609" id="pl6">
<input type="hidden" data-plid="7618" id="pl7">
<input type="hidden" data-plid="7627" id="pl8">
<script>
    var playGroupId = 3;
    var playId = 249;

        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('lhc-wsl_siwlbz')" class="active">四尾连不中</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9446"></strong></td>
                    <td><input type="checkbox" data-name="1" data-plid="9446"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9451"></strong></td>
                    <td><input type="checkbox" data-name="6" data-plid="9451"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9447"></strong></td>
                    <td><input type="checkbox" data-name="2" data-plid="9447"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9452"></strong></td>
                    <td><input type="checkbox" data-name="7" data-plid="9452"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9448"></strong></td>
                    <td><input type="checkbox" data-name="3" data-plid="9448"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9453"></strong></td>
                    <td><input type="checkbox" data-name="8" data-plid="9453"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9449"></strong></td>
                    <td><input type="checkbox" data-name="4" data-plid="9449"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9454"></strong></td>
                    <td><input type="checkbox" data-name="9" data-plid="9454"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9450"></strong></td>
                    <td><input type="checkbox" data-name="5" data-plid="9450"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9455"></strong></td>
                    <td><input type="checkbox" data-name="0" data-plid="9455"/></td>
                    <td>

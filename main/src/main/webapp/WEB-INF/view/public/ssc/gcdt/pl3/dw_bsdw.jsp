    ...
    <div class="fl main-left">
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('pl3-dw_bsdw')" class="active">百十定位</a>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                <thead>
                <tr>
                    <th colspan="21">百十定位（中2@<span class="pl red" data-plid="7911"></span>)</th>
                </tr>
                </thead>
                <tbody>
                <tr>
...
<input type="hidden" data-plid="7911" id="pl"/>

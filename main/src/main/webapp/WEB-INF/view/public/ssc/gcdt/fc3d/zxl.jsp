    ...
    <div class="fl main-left re-main-left">
        <div class="table-common">
            <table width="100%" border="1">
                <thead>
                <tr>
                    <th colspan="10"><strong>组选六@<span id="pl" class="pl red"></span></strong></strong>(请选择4~8个号码)</th>
                </tr>
                <tr>
                    <th>号码</th>
                    <th>选择</th>
...
<input type="hidden" data-plid="8187" id="pl4"/>
<input type="hidden" data-plid="8188" id="pl5"/>
<input type="hidden" data-plid="8189" id="pl6"/>
<input type="hidden" data-plid="8190" id="pl7"/>
<input type="hidden" data-plid="8191" id="pl8"/>
<script>
    var playGroupId = 5;
    var playId = 256;

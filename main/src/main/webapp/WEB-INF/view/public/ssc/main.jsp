...
<div class="menu_left">
    <div class="logo">
        <img src="<%=basePath%>images/${logo.imageId}" alt="" onclick="window.location.href='<%=basePath%>'"  class="gcdt_img" style="cursor:pointer">
            ...
            <li class="show">
                ...
                <div class="down" style="display: block;">
                    <div class="inner-menu">
                        ...
                        <h3 class="head-k3"><img src="${resPath}img/gd11x51.png" alt=""><var>11选5</var><i></i></h3>
                        <div class="xl-down xHide">

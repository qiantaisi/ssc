        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('efssc-zxs_q3')">前三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('efssc-zxs_z3')" class="active">中三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('efssc-zxs_h3')">后三组选三</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="11137" id="pl5"/>
<input type="hidden" data-plid="11136" id="pl6"/>
<input type="hidden" data-plid="11135" id="pl7"/>
<input type="hidden" data-plid="11134" id="pl8"/>
<input type="hidden" data-plid="11133" id="pl9"/>
<input type="hidden" data-plid="11132" id="pl10"/>
<script>
    var playGroupId = 16;
    var playId = 398;

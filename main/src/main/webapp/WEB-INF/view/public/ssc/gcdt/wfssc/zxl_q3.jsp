        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('wfssc-zxl_q3')" class="active">前三组选六</a>
...
<%-- 前三组选六 --%>
<input type="hidden" data-plid="11490" id="pl4"/>
<input type="hidden" data-plid="11489" id="pl5"/>
<input type="hidden" data-plid="11488" id="pl6"/>
<input type="hidden" data-plid="11487" id="pl7"/>
<input type="hidden" data-plid="11486" id="pl8"/>
<script>
    var playGroupId = 17;
    var playId = 403;

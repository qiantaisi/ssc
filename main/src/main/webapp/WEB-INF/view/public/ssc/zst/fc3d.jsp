    ...
    <div class="qc" id="Right">
        <div class="main">
            <div class="main-box" style="width:1162px;">
                <div class="main-nav">
                    <div class="cplogo"><img src="${resPath}zst/img/fc3d.png" alt="福彩3D" /><span>福彩3D</span></div>
                ...
                <div class="qhbox">
                    ...
                    <div class="shuoming qc">
                        ...
                        <div class="shuomingright" style="width:500px;">
                            ...
                            <a href="javascript:void(0)" onclick="getSscPage('gcdt/fc3d')"><img class="btnjiang" src="${resPath}zst/img/jiang.png" alt=""></a>
                            <div class="jiezhi">
                                <h3>
                                    <p>
                                        <font id="tip"></font>

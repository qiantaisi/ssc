    ...
    <div class="Pick cl-1002 recl-1002" data-flag="fu">
       ...
       <span class="fr fl cl-1001">
            ...
            <a><img src="${resPath}img/ico60.png" alt="">选号规则
                <var>投注方案：胆码08,拖码06<br> 开奖号码：06 08 11 09 02,即中任选二中二。</var>
            </a>
            <a>
    ...
    <div class="Pick cl-1002 recl-1002" data-flag="fu">
        ...
        <span class="fr fl cl-1001">
           从01-11中,选取3个及以上的号码进行投注,3个号码一注,每注需至少包括1个胆码及1个拖码。
            <a><img src="${resPath}img/ico60.png" alt="">选号规则
                <var>投注方案：胆码08,拖码06 11<br> 开奖号码：06 08 11 09 02，即中任选三中三。</var>
            </a>
            <a>
                <img src="${resPath}img/ico61.png" alt="">中奖说明
                <var>从01—11中选出3个或多个号码进行投注,每注需至少包括一个胆码及一个拖码,共3个号码所选单注号码与当期5个开奖号码中包含所选号码,即为中奖。</var>
            </a>
        </span>
        </p>
        <ul>
            ...
            <li data-name="拖码">
                <b><i>拖码</i></b>
                <var class="numLines dantuo_selected" data-name="danma3">
                    <span class="n1"><i>01</i></span>
                    <span class="n2"><i>02</i></span>
                    <span class="n3"><i>03</i></span>
                    <span class="n4"><i>04</i></span>
    ...
    <div class="Pick cl-1002 recl-1002" data-flag="fu">
        ...
        <span class="fr fl cl-1001">
           从01-11中,选取4个及以上的号码进行投注,4个号码一注,每注需至少包括1个胆码及1个拖码。
            <a><img src="${resPath}img/ico60.png" alt="">选号规则
                <var>投注方案：胆码08,拖码06 09 11<br> 开奖号码：06 08 11 09 02,即中任选四中四。</var>
            </a>
            <a>
                <img src="${resPath}img/ico61.png" alt="">中奖说明
        ...
        <ul>
            ...
            <li data-name="拖码">
                <b><i>拖码</i></b>
                <var class="numLines dantuo_selected" data-name="danma4">
                    <span class="n1"><i>01</i></span>
                    <span class="n2"><i>02</i></span>
                    <span class="n3"><i>03</i></span>
                    <span class="n4"><i>04</i></span>
    ...
    <div class="Pick cl-1002 recl-1002" data-flag="fu">
        ...
        <span class="fr fl cl-1001">
           从01-11中,选取5个及以上的号码进行投注,5个号码一注,每注需至少包括1个胆码及1个拖码。
            <a><img src="${resPath}img/ico60.png" alt="">选号规则
                <var>投注方案：胆码08,拖码02 06 09 11<br> 开奖号码：06 08 11 09 02,即中任选五中五。</var>
            </a>
            <a>
                <img src="${resPath}img/ico61.png" alt="">中奖说明
        ...
        <ul>
            ...
            <li data-name="拖码">
                <b><i>拖码</i></b>
                <var class="numLines dantuo_selected" data-name="danma5">
                    <span class="n1"><i>01</i></span>
                    <span class="n2"><i>02</i></span>
                    <span class="n3"><i>03</i></span>
                    <span class="n4"><i>04</i></span>
    ...
    <div class="Pick cl-1002 recl-1002" data-flag="fu">
        ...
        <span class="fr fl cl-1001">
           从01-11中，选取6个及以上的号码进行投注，6个号码一注，每注需至少包括1个胆码及1个拖码。
            <a><img src="${resPath}img/ico60.png" alt="">选号规则
                <var>投注方案：胆码08,拖码02 06 05 09 11<br> 开奖号码：06 08 11 09 02，即中任选六中五。</var>
            </a>
            <a>
                <img src="${resPath}img/ico61.png" alt="">中奖说明
        ...
        <ul>
            ...
            <li data-name="拖码">
                <b><i>拖码</i></b>
                <var class="numLines dantuo_selected" data-name="danma6">
                    <span class="n1"><i>01</i></span>
                    <span class="n2"><i>02</i></span>
                    <span class="n3"><i>03</i></span>
                    <span class="n4"><i>04</i></span>
    ...
    <div class="Pick cl-1002 recl-1002" data-flag="fu">
        ...
        <span class="fr fl cl-1001">
           从01-11中,选取7个及以上的号码进行投注,7个号码一注,每注需至少包括1个胆码及1个拖码。
            <a><img src="${resPath}img/ico60.png" alt="">选号规则
                <var>投注方案：胆码08,拖码01 02 06 05 09 11<br> 开奖号码：06 08 11 09 02,即中任选七中五。</var>
            </a>
            <a>
                <img src="${resPath}img/ico61.png" alt="">中奖说明
        ...
        <ul>
            ...
            <li data-name="拖码">
                <b><i>拖码</i></b>
                <var class="numLines dantuo_selected" data-name="danma7">
                    <span class="n1"><i>01</i></span>
                    <span class="n2"><i>02</i></span>
                    <span class="n3"><i>03</i></span>
                    <span class="n4"><i>04</i></span>
    ...
    <div class="Pick cl-1002 recl-1002" data-flag="fu">
        ...
        <span class="fr fl cl-1001">
           从01-11中,选取8个及以上的号码进行投注,8个号码一注,每注需至少包括1个胆码及1个拖码。
            <a><img src="${resPath}img/ico60.png" alt="">选号规则
                <var>投注方案：胆码08,拖码01 02 03 06 05 09 11<br> 开奖号码：06 08 11 09 02,即中任选八中五。</var>
            </a>
            <a>
                <img src="${resPath}img/ico61.png" alt="">中奖说明
        ...
        <ul>
            ...
            <li data-name="拖码">
                <b><i>拖码</i></b>
                <var class="numLines dantuo_selected" data-name="danma8">
                    <span class="n1"><i>01</i></span>
                    <span class="n2"><i>02</i></span>
                    <span class="n3"><i>03</i></span>
                    <span class="n4"><i>04</i></span>

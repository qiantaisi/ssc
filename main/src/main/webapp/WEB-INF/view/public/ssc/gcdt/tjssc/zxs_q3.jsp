        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('tjssc-zxs_q3')" class="active">前三组选三</a>
...
<input type="hidden" data-plid="7534" id="pl5"/>
<input type="hidden" data-plid="7543" id="pl6"/>
<input type="hidden" data-plid="7552" id="pl7"/>
<input type="hidden" data-plid="7561" id="pl8"/>
<input type="hidden" data-plid="7570" id="pl9"/>
<input type="hidden" data-plid="7579" id="pl10"/>
<script>
    var playGroupId = 2;
    var playId = 236;

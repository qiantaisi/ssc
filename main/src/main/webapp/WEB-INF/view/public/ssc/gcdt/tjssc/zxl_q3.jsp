    ...
    <div class="fl main-left">
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('tjssc-zxl_q3')" class="active">前三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('tjssc-zxl_z3')">中三组选六</a>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                <thead>
                <tr>
                    <th colspan="10"><strong>前三组选六@<font id="pl" class="pl red"></font>(请选择4~8个号码)</th>
                </tr>
                <tr>
                    <th>号码</th>
                    <th>选择</th>
...
<%-- 前三组选六 --%>
<input type="hidden" data-plid="7588" id="pl4"/>
<input type="hidden" data-plid="7597" id="pl5"/>
<input type="hidden" data-plid="7606" id="pl6"/>
<input type="hidden" data-plid="7615" id="pl7"/>
<input type="hidden" data-plid="7624" id="pl8"/>
<script>
    var playGroupId = 2;
    var playId = 237;

        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('sfssc-zxs_q3')" class="active">前三组选三</a>
...
<input type="hidden" data-plid="10319" id="pl5"/>
<input type="hidden" data-plid="10318" id="pl6"/>
<input type="hidden" data-plid="10317" id="pl7"/>
<input type="hidden" data-plid="10316" id="pl8"/>
<input type="hidden" data-plid="10315" id="pl9"/>
<input type="hidden" data-plid="10314" id="pl10"/>
<script>
    var playGroupId = 13;
    var playId = 341;

        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('ffssc-zxs_q3')" class="active">前三组选三</a>
...
<input type="hidden" data-plid="10811" id="pl5"/>
<input type="hidden" data-plid="10810" id="pl6"/>
<input type="hidden" data-plid="10809" id="pl7"/>
<input type="hidden" data-plid="10808" id="pl8"/>
<input type="hidden" data-plid="10807" id="pl9"/>
<input type="hidden" data-plid="10806" id="pl10"/>
<script>
    var playGroupId = 15;
    var playId = 386;

                ...
                <ul>
                    <li class="gf-li">
                        ...
                        <p class="guanfang respan gf-cgwf respanw" data-name="gfwf">
                            ...
                            <span><a href="javascript:void(0)" data-url="gfwf-jspk10-qe">前二</a></span>
                    ...
                    <li>
                        ...
                        <p class="kuaiqian">
                            ...
                            <span><a href="javascript:void(0)" data-url="jspk10-lmp">两面盘</a></span>
                            <span class="pm"><a href="javascript:void(0)" data-url="jspk10-pm1d10">排名1~10</a></span>
                            <span class="gyzh"><a href="javascript:void(0)" data-url="jspk10-gyjh">冠、亚军 组合</a></span>
                            <%--<span class="cmc"><a href="javascript:void(0)" data-url="jspk10-pm3456">三、四、五、六名</a></span>--%>
                            <%--<span class="cmc"><a href="javascript:void(0)" data-url="jspk10-pm78910">七、八、九、十名</a></span>--%>
                        </p>
                    </li>
                </ul>
            </div>

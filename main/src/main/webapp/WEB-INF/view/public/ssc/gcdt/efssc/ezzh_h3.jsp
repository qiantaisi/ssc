    ...
    <div class="fl main-left">
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('efssc-ezzh_q3')">前三二字组合</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('efssc-ezzh_z3')">中三二字组合</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('efssc-ezzh_h3')" class="active">后三二字组合</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                <thead>
                <tr>
                    <th colspan="20">第一个投注码@<span data-plid="11036" class="pl red"></span></th>
                </tr>
                </thead>
            ...
            <table width="100%" border="1">
                <thead>
                <tr>
                    <th colspan="20">第二个投注码@<font data-plid="11036" class="pl red"></font></th>
                </tr>
                </thead>
...
<input type="hidden" data-plid="11036" id="pl">
<script>
    var playGroupId = 16;
    var playId = 396;

    ...
    <div class="fl main-left">
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('wfssc-zxs_q3')">前三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('wfssc-zxs_z3')" class="active">中三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('wfssc-zxs_h3')">后三组选三</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                <thead>
                <tr>
                    <th colspan="10"><strong>中三组选三@<font id="pl" class="pl red"></font></strong> (请选择5个及以上号码)</th>
                </tr>
                <tr>
                    <th>号码</th>
                    <th>选择</th>
...
<input type="hidden" data-plid="11469" id="pl5"/>
<input type="hidden" data-plid="11468" id="pl6"/>
<input type="hidden" data-plid="11467" id="pl7"/>
<input type="hidden" data-plid="11466" id="pl8"/>
<input type="hidden" data-plid="11465" id="pl9"/>
<input type="hidden" data-plid="11464" id="pl10"/>
<script>
    var playGroupId = 17;
    var playId = 410;

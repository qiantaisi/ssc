        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('sfssc-zxs_q3')">前三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sfssc-zxs_z3')" class="active">中三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sfssc-zxs_h3')">后三组选三</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="10313" id="pl5"/>
<input type="hidden" data-plid="10312" id="pl6"/>
<input type="hidden" data-plid="10311" id="pl7"/>
<input type="hidden" data-plid="10310" id="pl8"/>
<input type="hidden" data-plid="10309" id="pl9"/>
<input type="hidden" data-plid="10308" id="pl10"/>
<script>
    var playGroupId = 13;
    var playId = 341;

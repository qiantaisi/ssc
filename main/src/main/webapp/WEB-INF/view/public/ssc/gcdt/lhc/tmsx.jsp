        ...
        <div class="table-common">
            <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6769"></strong></td>
                    <td><input type="text" class="table-txt" data-name="鼠" data-plid="6769"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="6770"></strong></td>
                    <td><input type="text" class="table-txt" data-name="牛" data-plid="6770"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6771"></strong></td>
                    <td><input type="text" class="table-txt" data-name="虎" data-plid="6771"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="6772"></strong></td>
                    <td><input type="text" class="table-txt" data-name="兔" data-plid="6772"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6773"></strong></td>
                    <td><input type="text" class="table-txt" data-name="龙" data-plid="6773"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="6774"></strong></td>
                    <td><input type="text" class="table-txt" data-name="蛇" data-plid="6774"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6775"></strong></td>
                    <td><input type="text" class="table-txt" data-name="马" data-plid="6775"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="6776"></strong></td>
                    <td><input type="text" class="table-txt" data-name="羊" data-plid="6776"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6777"></strong></td>
                    <td><input type="text" class="table-txt" data-name="猴" data-plid="6777"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="6778"></strong></td>
                    <td><input type="text" class="table-txt" data-name="鸡" data-plid="6778"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6779"></strong></td>
                    <td><input type="text" class="table-txt" data-name="狗" data-plid="6779"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="6780"></strong></td>
                    <td><input type="text" class="table-txt" data-name="猪" data-plid="6780"/></td>
                    <td>

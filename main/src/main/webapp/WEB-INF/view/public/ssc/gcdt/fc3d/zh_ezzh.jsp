    ...
    <div class="fl main-left">
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('fc3d-zh_ezzh')" class="active">二字组合</a>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                <thead>
                <tr>
                    <th colspan="20">二字组合（二字相同@<span class="pl red" data-plid="7935"></span>二字不同@<span class="pl red"
                                                                                                       data-plid="7936"></span>)
                    </th>
                </tr>
                <tr>
...
<input type="hidden" data-plid="7935" id="plxt"/>
<input type="hidden" data-plid="7936" id="plbt"/>

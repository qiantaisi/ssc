    ...
    <div class="qc" id="Right">
        <div class="main">
            <div class="main-box" style="width:2402px;">
                <div class="main-nav">
                    <div class="cplogo"><img src="${resPath}zst/img/bjpk10.png" alt="PK10" /><span>PK10</span></div>
                ...
                <div class="qhbox">
                    ...
                    <div class="shuoming qc">
                        ...
                        <div class="shuomingright" style="width:500px;">
                            ...
                            <a href="javascript:void(0)" onclick="getSscPage('gcdt/pk10')"><img class="btnjiang" src="${resPath}zst/img/jiang.png" alt=""></a>
                            <div class="jiezhi">
                                <h3>
                                    <p>
                                        <font id="tip"></font>

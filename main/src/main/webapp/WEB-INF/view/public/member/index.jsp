...
<div class="wid-1200 helpCont clearfix">
    <div class="head headmemberbg">
        ...
        <%
            if (StringUtils.equals("400w", SessionUtils.getSessionCompanyShortName(request))) {
        %>
            <img style="max-height: 50px;" src="<%=basePath%>static/theme/400w/images/pclogo.png?v=0.001" alt="">
        <%
        }else {
        %>

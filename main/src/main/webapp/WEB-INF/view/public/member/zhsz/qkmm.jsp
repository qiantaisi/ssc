...
<div class="help_r_main">
    <c:choose>
        <c:when test="${FisrtWithdrawPasswd.userIsFirstWithdrawPasswd == true}">
                ...
                <div class="form_content hideForm">
                    <form name="setPasswordForm" novalidate="novalidate" onsubmit="return false;">
                        <ul class="eveb_form eveb_setting_form re-withdraw-ul">
                            ...
                            <li>
                                <span>确认取款密码：</span>
                                <input name="confirmWithdrawPassword" id="confirmWithdrawPassword" type="password" size="20" class="passwinp">

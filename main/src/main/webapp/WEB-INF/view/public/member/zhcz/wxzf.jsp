            ...
            <ul class="eveb_form">
                <li>
                    ...
                    <div class="eveb_form_box eveb_bank_list">
                        <c:forEach items="${wxzfInfo.systemPayOnlineList}" var="item">
                            <label>
...
//                $("#zfsm").hide();
        ...
        $("form[name='wxzfForm']").submit(function() {
            ...
            window.open("http://" + payurl + "/pay/payOnlineRequest.html?refer=" + location.protocol + "//" + location.host + "&uid=${userSession.id}&money=" + money + "&payOnlineId=" + $("form[name='wxzfForm'] input[name='payOnlineId']:checked").val());
        });

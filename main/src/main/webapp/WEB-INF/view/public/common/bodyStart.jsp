...
<head>
    ...
    <link rel="stylesheet" href="${resPath}css/style.css?v=201709061" type="text/css"><!--页面CSS-->
    ...
    <link rel="stylesheet" href="${resPath}css/other.css?v=20170817" type="text/css"><!--页面CSS-->
    <link rel="stylesheet" href="${resPath}css/gfwf.css?v=201709021" type="text/css"><!--页面CSS-->

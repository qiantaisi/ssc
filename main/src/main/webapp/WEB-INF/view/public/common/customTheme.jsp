...
<c:if test="${not empty fengge_1}">
    <style>
        ...
        .process .layout .list_tems .date span, .process .layout .list_tems .date h3,.eveb_amount span,.color-e77c3c,.eveb_setting_table a{color: #${fengge_1}!important;}

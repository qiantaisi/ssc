...
<c:if test="${not empty fengge_1}">
    <style>
        ...
        .process .layout .list_tems .date span, .process .layout .list_tems .date h3,.eveb_sub_nav_type li.on a:link,.eveb_sub_nav_type li.on a:hover{color: #${fengge_1}!important;}

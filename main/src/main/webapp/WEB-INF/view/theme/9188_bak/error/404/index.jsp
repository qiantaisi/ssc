...
<div class="w1000 header">
    <%--<div class="fl"><img class="logo" src="${resPath}error/404/images/logo.png"></div>--%>
    <%--<div class="fr home"><a href="<%=basePath%>" class="btn org">返回首页>></a></div>--%>
</div>
<div class="main404"><img class="logo" src="${resPath}error/404/images/404.png"></div>
<ul class="list_btn">
    <%--<li><a href="<%=basePath%>member/index.html" class="btn green">个人中心</a></li>--%>
    <li><a href="<%=basePath%>" class="btn org">首页</a></li>
        <c:choose>
            <c:when test="${not empty kefuUrl}">
                <li><a href="${kefuUrl}" class="btn org" target="_blank">在线客服</a></li>
            </c:when>
            <c:otherwise>
                <li><a href="#" class="btn org" target="_blank">在线客服</a></li>
            </c:otherwise>
        </c:choose>
    <li><a href="<%=basePath%>ssc/index.html" class="btn blue">购彩大厅</a></li>
    <li><a href="javascript:void(0)" onclick="history.go(-1)" class="btn org">返回上一页</a></li>
</ul>
<div class="footer">Copyright©2016 ${webName} All Rights Reserved</div>
</body>
</html>

    ...
    <div class="fl main-left">
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('fc3d-dw_bsdw')" class="active">百十定位</a>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                <thead>
                <tr>
                    <th colspan="21">百十定位（中2@<span class="pl red" data-plid="7907"></span>)</th>
                </tr>
                </thead>
                <tbody>
                <tr>
...
<input type="hidden" data-plid="7907" id="pl"/>
<script>
    var playGroupId = 5;
    var playId = 252;

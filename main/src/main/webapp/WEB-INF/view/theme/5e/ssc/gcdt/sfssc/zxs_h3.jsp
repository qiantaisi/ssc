    ...
    <div class="fl main-left">
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('sfssc-zxs_z3')">中三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sfssc-zxs_h3')" class="active">后三组选三</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                <thead>
                <tr>
                    <th colspan="10"><strong>后三组选三@<font id="pl" class="pl red"></font></strong> (请选择5个及以上号码)</th>
                </tr>
                <tr>
                    <th>号码</th>
                    <th>选择</th>
...
<input type="hidden" data-plid="10307" id="pl5"/>
<input type="hidden" data-plid="10306" id="pl6"/>
<input type="hidden" data-plid="10305" id="pl7"/>
<input type="hidden" data-plid="10304" id="pl8"/>
<input type="hidden" data-plid="10303" id="pl9"/>
<input type="hidden" data-plid="10302" id="pl10"/>

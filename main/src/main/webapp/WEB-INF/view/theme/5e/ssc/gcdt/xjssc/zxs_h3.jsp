        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix"  style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-zxs_z3')">中三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-zxs_h3')" class="active">后三组选三</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="7539" id="pl5">
<input type="hidden" data-plid="7548" id="pl6">
<input type="hidden" data-plid="7557" id="pl7">
<input type="hidden" data-plid="7566" id="pl8">
<input type="hidden" data-plid="7575" id="pl9">
<input type="hidden" data-plid="7584" id="pl10">
<script>
    var playGroupId = 3;
    var playId = 248;

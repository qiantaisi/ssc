        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('ffssc-zxs_q3')">前三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('ffssc-zxs_z3')" class="active">中三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('ffssc-zxs_h3')">后三组选三</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="10805" id="pl5"/>
<input type="hidden" data-plid="10804" id="pl6"/>
<input type="hidden" data-plid="10803" id="pl7"/>
<input type="hidden" data-plid="10802" id="pl8"/>
<input type="hidden" data-plid="10801" id="pl9"/>
<input type="hidden" data-plid="10800" id="pl10"/>
<script>
    var playGroupId = 15;
    var playId = 386;

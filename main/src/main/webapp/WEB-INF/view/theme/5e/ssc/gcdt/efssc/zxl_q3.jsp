        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('efssc-zxl_q3')" class="active">前三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('efssc-zxl_z3')">中三组选六</a>
...
<%-- 前三组选六 --%>
<input type="hidden" data-plid="11158" id="pl4"/>
<input type="hidden" data-plid="11157" id="pl5"/>
<input type="hidden" data-plid="11156" id="pl6"/>
<input type="hidden" data-plid="11155" id="pl7"/>
<input type="hidden" data-plid="11154" id="pl8"/>
<script>
    var playGroupId = 16;
    var playId = 391;

        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('lhc-lx_sxlz')" class="active">三肖连中</a>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9379"></strong></td>
                    <td><input type="checkbox" data-plid="9379" data-name="鼠"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9383"></strong></td>
                    <td><input type="checkbox" data-plid="9383" data-name="牛"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9387"></strong></td>
                    <td><input type="checkbox" data-plid="9387" data-name="虎"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9391"></strong></td>
                    <td><input type="checkbox" data-plid="9391" data-name="兔"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9395"></strong></td>
                    <td><input type="checkbox" data-plid="9395" data-name="龙"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9399"></strong></td>
                    <td><input type="checkbox" data-plid="9399" data-name="蛇"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9403"></strong></td>
                    <td><input type="checkbox" data-plid="9403" data-name="马"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9407"></strong></td>
                    <td><input type="checkbox" data-plid="9407" data-name="羊"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9411"></strong></td>
                    <td><input type="checkbox" data-plid="9411" data-name="猴"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9415"></strong></td>
                    <td><input type="checkbox" data-plid="9415" data-name="鸡"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9419"></strong></td>
                    <td><input type="checkbox" data-plid="9419" data-name="狗"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9423"></strong></td>
                    <td><input type="checkbox" data-plid="9423" data-name="猪"/></td>
                    <td>

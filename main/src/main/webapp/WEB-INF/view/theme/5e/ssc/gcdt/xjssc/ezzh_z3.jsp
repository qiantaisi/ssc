    ...
    <div class="fl main-left">
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix"  style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-ezzh_z3')" class="active">中三二字组合</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-ezzh_h3')">后三二字组合</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                <thead>
                <tr>
                    <th colspan="20">第一个投注码@<font data-plid="8602" class="pl red"></font></th>
                </tr>
                </thead>
            ...
            <table width="100%" border="1">
                <thead>
                <tr>
                    <th colspan="20">第二个投注码@<font data-plid="8602" class="pl red"></font></th>
                </tr>
                </thead>
...
<input type="hidden" data-plid="8602" id="pl"/>

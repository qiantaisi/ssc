        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('efssc-zxl_h3')" class="active">后三组选六</a>
                </div>
            </div>
        </div>
...
<%-- 后三组选六 --%>
<input type="hidden" data-plid="11148" id="pl4"/>
<input type="hidden" data-plid="11147" id="pl5"/>
<input type="hidden" data-plid="11146" id="pl6"/>
<input type="hidden" data-plid="11145" id="pl7"/>
<input type="hidden" data-plid="11144" id="pl8"/>
<script>
    var playGroupId = 16;
    var playId = 391;

    ...
    <div class="fl main-left">
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('tjssc-zxs_z3')" class="active">中三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('tjssc-zxs_h3')">后三组选三</a>
                </div>
            </div>
        </div>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                <thead>
                <tr>
                    <th colspan="10"><strong>中三组选三@<span id="pl" class="pl red"></span></strong> (请选择5个及以上号码)</th>
                </tr>
                <tr>
                    <th>号码</th>
                    <th>选择</th>
...
<input type="hidden" data-plid="7535" id="pl5"/>
<input type="hidden" data-plid="7544" id="pl6"/>
<input type="hidden" data-plid="7553" id="pl7"/>
<input type="hidden" data-plid="7562" id="pl8"/>
<input type="hidden" data-plid="7571" id="pl9"/>
<input type="hidden" data-plid="7580" id="pl10"/>
<script>
    var playGroupId = 2;
    var playId = 236;

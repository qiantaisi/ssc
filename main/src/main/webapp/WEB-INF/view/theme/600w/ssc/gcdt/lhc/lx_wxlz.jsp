        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('lhc-lx_sixlz')">四肖连中</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('lhc-lx_wxlz')" class="active">五肖连中</a>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9381"></strong></td>
                    <td><input type="checkbox" data-plid="9381" data-name="鼠"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9385"></strong></td>
                    <td><input type="checkbox" data-plid="9385" data-name="牛"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9389"></strong></td>
                    <td><input type="checkbox" data-plid="9389" data-name="虎"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9393"></strong></td>
                    <td><input type="checkbox" data-plid="9393" data-name="兔"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9397"></strong></td>
                    <td><input type="checkbox" data-plid="9397" data-name="龙"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9401"></strong></td>
                    <td><input type="checkbox" data-plid="9401" data-name="蛇"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9405"></strong></td>
                    <td><input type="checkbox" data-plid="9405" data-name="马"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9409"></strong></td>
                    <td><input type="checkbox" data-plid="9409" data-name="羊"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9413"></strong></td>
                    <td><input type="checkbox" data-plid="9413" data-name="猴"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9417"></strong></td>
                    <td><input type="checkbox" data-plid="9417" data-name="鸡"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9421"></strong></td>
                    <td><input type="checkbox" data-plid="9421" data-name="狗"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9425"></strong></td>
                    <td><input type="checkbox" data-plid="9425" data-name="猪"/></td>
                    <td>

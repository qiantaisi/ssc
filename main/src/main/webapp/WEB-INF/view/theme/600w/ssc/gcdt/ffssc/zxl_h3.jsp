        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('ffssc-zxl_z3')">中三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('ffssc-zxl_h3')" class="active">后三组选六</a>
                </div>
            </div>
        </div>
...
<%-- 后三组选六 --%>
<input type="hidden" data-plid="10816" id="pl4"/>
<input type="hidden" data-plid="10815" id="pl5"/>
<input type="hidden" data-plid="10814" id="pl6"/>
<input type="hidden" data-plid="10813" id="pl7"/>
<input type="hidden" data-plid="10812" id="pl8"/>
<script>
    var playGroupId = 15;
    var playId = 379;

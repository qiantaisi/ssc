    ...
    <div class="qc" id="Right">
        <div class="main">
            <div class="main-box" style="width:1100px;">
                <div class="main-nav">
                    <div class="cplogo"><img src="${resPath}img/sflhc.png" alt="10分六合彩" /><span>10分六合彩</span></div>
                    ...
                    <ul class="btn-navs">
                        ...
                        <li>
                            <a href="javascript:void(0)" onclick="getSscPage('gcdt/sflhc')">立即投注</a>
                        </li>
                    </ul>
                </div>
                <div class="qhbox">
                    ...
                    <div class="shuoming qc">
                        ...
                        <div class="shuomingright" style="width:500px;">
                            ...
                            <a href="javascript:void(0)" onclick="getSscPage('gcdt/sflhc')"><img class="btnjiang" src="${resPath}zst/img/jiang.png" alt=""></a>
                            <div class="jiezhi">
                                <h3>
                                    <p>
                                        <font id="tip"></font>
                            ...
                            <div class="zhushi">每天销售144期&nbsp;&nbsp;每10分钟一期</div>
                            <div class="tongzhi">
                            </div>
                        </div>
                </div>

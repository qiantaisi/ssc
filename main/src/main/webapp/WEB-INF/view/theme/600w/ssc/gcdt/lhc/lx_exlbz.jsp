        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('lhc-lx_exlbz')" class="active">二肖连不中</a>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6795"></strong></td>
                    <td><input type="checkbox" data-plid="6795" data-name="鼠"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="6795"></strong></td>
                    <td><input type="checkbox" data-plid="6795" data-name="牛"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6795"></strong></td>
                    <td><input type="checkbox" data-plid="6795" data-name="虎"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="6795"></strong></td>
                    <td><input type="checkbox" data-plid="6795" data-name="兔"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6795"></strong></td>
                    <td><input type="checkbox" data-plid="6795" data-name="龙"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="6795"></strong></td>
                    <td><input type="checkbox" data-plid="6795" data-name="蛇"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6795"></strong></td>
                    <td><input type="checkbox" data-plid="6795" data-name="马"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="6795"></strong></td>
                    <td><input type="checkbox" data-plid="6795" data-name="羊"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6795"></strong></td>
                    <td><input type="checkbox" data-plid="6795" data-name="猴"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="6795"></strong></td>
                    <td><input type="checkbox" data-plid="6795" data-name="鸡"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="6795"></strong></td>
                    <td><input type="checkbox" data-plid="6795" data-name="狗"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="6795"></strong></td>
                    <td><input type="checkbox" data-plid="6795" data-name="猪"/></td>
                    <td>

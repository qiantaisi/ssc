        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('ffssc-zxl_q3')">前三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('ffssc-zxl_z3')" class="active">中三组选六</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('ffssc-zxl_h3')">后三组选六</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="10821" id="pl4"/>
<input type="hidden" data-plid="10820" id="pl5"/>
<input type="hidden" data-plid="10819" id="pl6"/>
<input type="hidden" data-plid="10818" id="pl7"/>
<input type="hidden" data-plid="10817" id="pl8"/>

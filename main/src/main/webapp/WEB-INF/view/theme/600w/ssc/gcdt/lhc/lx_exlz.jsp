        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('lhc-lx_exlz')" class="active">二肖连中</a>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9378"></strong></td>
                    <td><input type="checkbox" data-plid="9378" data-name="鼠"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9382"></strong></td>
                    <td><input type="checkbox" data-plid="9382" data-name="牛"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9386"></strong></td>
                    <td><input type="checkbox" data-plid="9386" data-name="虎"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9390"></strong></td>
                    <td><input type="checkbox" data-plid="9390" data-name="兔"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9394"></strong></td>
                    <td><input type="checkbox" data-plid="9394" data-name="龙"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9398"></strong></td>
                    <td><input type="checkbox" data-plid="9398" data-name="蛇"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9402"></strong></td>
                    <td><input type="checkbox" data-plid="9402" data-name="马"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9406"></strong></td>
                    <td><input type="checkbox" data-plid="9406" data-name="羊"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9410"></strong></td>
                    <td><input type="checkbox" data-plid="9410" data-name="猴"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9414"></strong></td>
                    <td><input type="checkbox" data-plid="9414" data-name="鸡"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="9418"></strong></td>
                    <td><input type="checkbox" data-plid="9418" data-name="狗"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="9422"></strong></td>
                    <td><input type="checkbox" data-plid="9422" data-name="猪"/></td>
                    <td>

                ...
                <ul>
                    <li>
                        ...
                        <p class="kuaiqian">
                            ...
                            <span><a href="javascript:void(0)" data-url="ahk3-hz">和值</a></span>
                            <span><a href="javascript:void(0)" data-url="ahk3-tx">通选</a></span>
                            <span style="width: 80px"><a href="javascript:void(0)"  data-url="ahk3-sthdx">三同号单选</a></span>
                            <span><a href="javascript:void(0)" data-url="ahk3-sbt">三不同</a></span>
                            <span style="width: 80px"><a href="javascript:void(0)" data-url="ahk3-ethfx">二同号复选</a></span>
                            <span style="width: 80px"><a href="javascript:void(0)" data-url="ahk3-ethdx">二同号单选</a></span>
                            <span><a href="javascript:void(0)" data-url="ahk3-ebth">二不同号</a></span>
                            <span><a href="javascript:void(0)" data-url="ahk3-cbc">猜必出</a></span>
                            <span style="width: 80px"><a href="javascript:void(0)" data-url="ahk3-cbbc">猜必不出</a></span>
                        </p>
                    </li>
                </ul>
            </div>

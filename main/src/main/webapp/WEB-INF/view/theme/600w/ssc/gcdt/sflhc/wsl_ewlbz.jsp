        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-wsl_ewlbz')" class="active">二尾连不中</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('sflhc-wsl_swlbz')">三尾连不中</a>
        ...
        <div class="table-common">
            <table width="100%" border="1">
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="13935"></strong></td>
                    <td><input type="checkbox" data-name="1" data-plid="13935"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="13940"></strong></td>
                    <td><input type="checkbox" data-name="6" data-plid="13940"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="13936"></strong></td>
                    <td><input type="checkbox" data-name="2" data-plid="13936"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="13941"></strong></td>
                    <td><input type="checkbox" data-name="7" data-plid="13941"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="13937"></strong></td>
                    <td><input type="checkbox" data-name="3" data-plid="13937"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="13942"></strong></td>
                    <td><input type="checkbox" data-name="8" data-plid="13942"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="13938"></strong></td>
                    <td><input type="checkbox" data-name="4" data-plid="13938"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="13943"></strong></td>
                    <td><input type="checkbox" data-name="9" data-plid="13943"/></td>
                    <td>
                ...
                <tr>
                    ...
                    <td><strong class="color-red pl" data-plid="13939"></strong></td>
                    <td><input type="checkbox" data-name="5" data-plid="13939"/></td>
                    <td>
                    ...
                    <td><strong class="color-red pl" data-plid="13934"></strong></td>
                    <td><input type="checkbox" data-name="0" data-plid="13934"/></td>
                    <td>
...
<input type="hidden" data-plid="6801" id="pl"/>
<script>
    var playGroupId = 22;
    var playId = 481;

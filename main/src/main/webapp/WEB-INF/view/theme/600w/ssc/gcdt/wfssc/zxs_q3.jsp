        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('wfssc-zxs_q3')" class="active">前三组选三</a>
...
<input type="hidden" data-plid="11475" id="pl5"/>
<input type="hidden" data-plid="11474" id="pl6"/>
<input type="hidden" data-plid="11473" id="pl7"/>
<input type="hidden" data-plid="11472" id="pl8"/>
<input type="hidden" data-plid="11471" id="pl9"/>
<input type="hidden" data-plid="11470" id="pl10"/>
<script>
    var playGroupId = 17;
    var playId = 410;

...
<div class="eveb_content">
    <div class="eveb_nav_sub">
        <ul class="clearfix">
            ...
            <c:if test="${not empty zfbzfInfo.systemPayOnlineList}"><li class="on"><a href="javascript:void(0)" onclick="parent.getPage('zhcz/zfbzf')">支付宝支付</a></li></c:if>
...
//                $("#zfsm").hide();
        ...
        $("form[name='zfbzfForm']").submit(function() {
            ...
            window.open("http://" + payurl + "/pay/payOnlineRequest.html?refer=<%=basePath%>&uid=${userSession.id}&money=" + money + "&payOnlineId=" + $("form[name='zfbzfForm'] input[name='payOnlineId']:checked").val());
        });

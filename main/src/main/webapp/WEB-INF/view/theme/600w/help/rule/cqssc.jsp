        ...
        <div class="help_list">
            ...
            <div class="help_col gfwf-help-col">
                <div class="gfwf-1">
                    ...
                    <div class="gfwf-3">
                        ...
                        1. 本站重庆时时彩游戏每天进行仅120期，开奖时间为白天10:00至22:00，每隔10分钟开奖一次；夜场22:00至凌晨01:55，每5分钟开奖一次。购买者可在对其选定的投注号码进行投注，返点越高则投注赔率越低。
                        ...
                        <div class="gfwf-wxsm">
                            <img src="${resPath}images/wfsm/wfsm-04.png" class="wfsm">
                        </div>
                        <br>
                        <b><p id="test7">七、玩法特点</p></b>
                        <div class="gfwf-wxsm">
                            <img src="${resPath}images/wfsm/wfsm05.png" class="wfsm">
                        </div></br>
                        <div class="wfsm-top">
         ...
         <a onclick="javascript:document.getElementById('top').scrollIntoView()" href="javascript:;">回到顶部</a></br>
            ...
            <div class="help_col">
                ...
                <p>重庆时时彩游戏是依照中国重庆福利彩票发行中心统一发行的『时时彩』彩票的开奖数据为依据所规划的线上彩票游戏，游戏的投注时间、开奖时间和开奖号码与重庆时时彩完全同步，北京时间（GMT+8）每天白天从上午10：00开到晚上22：00，夜场从22：00至凌晨 2 点，每 10 分钟开一次奖，夜场每 5 分钟开一次奖，每天开奖 120 期（白天 72 期，夜间 48 期） 。本公司重庆时时彩具体游戏规则请参考彩种介绍。</br>

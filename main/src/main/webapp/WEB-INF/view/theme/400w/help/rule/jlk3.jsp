    ...
    <div class="rt">
        ...
        <div class="help_list">
            ...
            <div class="help_col">
                ...
                2.	中国福利彩票吉林省快三游戏（以下简称“快三”）由中国福利彩票发行管理中心和组织销售，吉林省福利彩票销售机构（以下称“吉林福彩机构”）在所辖区域内承销。
                3.	快三采用计算机网络系统发行，在吉林福彩机构设置的销售网点销售，定期开奖。
                4.	快三实行自愿购买，凡购买该彩票均被视为同意并遵守本规则。
                5.	不得向未成年人出售彩票或兑付奖金。
                本站吉林快三游戏每天进行82期，开奖时间为08:39至22:10，每隔10分钟开奖一次。快三采用专用电子开奖设备开奖，每期随机生成3个号码，作为当期中奖号码。<span style="color:#E53333;">开奖结果为三码 (百、十、个)。假设结果为1 、2 、3。</span></p>
            </div>
        </div>
    </div>
</div>

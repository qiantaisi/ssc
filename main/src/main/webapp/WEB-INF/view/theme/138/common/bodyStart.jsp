...
<head>
    ...
    <link rel="stylesheet" href="${resPath}css/style.css?v=20170819" type="text/css"><!--页面CSS-->
    ...
    <link rel="stylesheet" href="${resPath}css/login.css?v=20170826" type="text/css"><!--页面CSS-->

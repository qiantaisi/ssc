        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('efssc-zxs_q3')" class="active">前三组选三</a>
...
<input type="hidden" data-plid="11143" id="pl5"/>
<input type="hidden" data-plid="11142" id="pl6"/>
<input type="hidden" data-plid="11141" id="pl7"/>
<input type="hidden" data-plid="11140" id="pl8"/>
<input type="hidden" data-plid="11139" id="pl9"/>
<input type="hidden" data-plid="11138" id="pl10"/>
<script>
    var playGroupId = 16;
    var playId = 398;

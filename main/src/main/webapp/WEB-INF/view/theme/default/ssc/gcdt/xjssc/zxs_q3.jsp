        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix"  style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('xjssc-zxs_q3')" class="active">前三组选三</a>
...
<input type="hidden" data-plid="7537" id="pl5"/>
<input type="hidden" data-plid="7546" id="pl6"/>
<input type="hidden" data-plid="7555" id="pl7"/>
<input type="hidden" data-plid="7564" id="pl8"/>
<input type="hidden" data-plid="7573" id="pl9"/>
<input type="hidden" data-plid="7582" id="pl10"/>
<script>
    var playGroupId = 3;
    var playId = 248;

        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix" style="margin-top: 4.4px; ">
                    ...
                    <a href="javascript:void(0)" onclick="getSscSubPage('wfssc-zxs_z3')">中三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('wfssc-zxs_h3')" class="active">后三组选三</a>
                </div>
            </div>
        </div>
...
<input type="hidden" data-plid="11463" id="pl5"/>
<input type="hidden" data-plid="11462" id="pl6"/>
<input type="hidden" data-plid="11461" id="pl7"/>
<input type="hidden" data-plid="11460" id="pl8"/>
<input type="hidden" data-plid="11459" id="pl9"/>
<input type="hidden" data-plid="11458" id="pl10"/>

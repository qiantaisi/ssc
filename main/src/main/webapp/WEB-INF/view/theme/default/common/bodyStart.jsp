...
<head>
    ...
    <link rel="stylesheet" href="${resPath}css/style.css?v=20170329" type="text/css"><!--页面CSS-->
    ...
    <link rel="stylesheet" href="${resPath}css/other.css?v=20170426" type="text/css"><!--页面CSS-->

    ...
    <div class="fl main-left">
        ...
        <div class="table-common">
            <table width="100%" border="1">
                ...
                <tr>
                    <td>红单</td>
                    <td><strong class="color-red pl" data-plid="6729"></strong></td>
                ...
                <tr>
                    <td>红双</td>
                    <td><strong class="color-red pl" data-plid="6730"></strong></td>
                ...
                <tr>
                    <td>红大</td>
                    <td><strong class="color-red pl" data-plid="6731"></strong></td>
                ...
                <tr>
                    <td>红小</td>
                    <td><strong class="color-red pl" data-plid="6732"></strong></td>
                ...
                <tr>
                    <td>绿单</td>
                    <td><strong class="color-red pl" data-plid="6737"></strong></td>
                ...
                <tr>
                    <td>绿双</td>
                    <td><strong class="color-red pl" data-plid="6738"></strong></td>
                ...
                <tr>
                    <td>绿大</td>
                    <td><strong class="color-red pl" data-plid="6739"></strong></td>
                ...
                <tr>
                    <td>绿小</td>
                    <td><strong class="color-red pl" data-plid="6740"></strong></td>
                ...
                <tr>
                    <td>蓝单</td>
                    <td><strong class="color-red pl" data-plid="6733"></strong></td>
                ...
                <tr>
                    <td>蓝双</td>
                    <td><strong class="color-red pl" data-plid="6734"></strong></td>
                ...
                <tr>
                    <td>蓝大</td>
                    <td><strong class="color-red pl" data-plid="6735"></strong></td>
                ...
                <tr>
                    <td>蓝小</td>
                    <td><strong class="color-red pl" data-plid="6736"></strong></td>
                ...
                <tr>
                    <td>红合单</td>
                    <td><strong class="color-red pl" data-plid="6741"></strong></td>
                ...
                <tr>
                    <td>红合双</td>
                    <td><strong class="color-red pl" data-plid="6742"></strong></td>
                ...
                <tr>
                    <td>绿合单</td>
                    <td><strong class="color-red pl" data-plid="6745"></strong></td>
                ...
                <tr>
                    <td>绿合双</td>
                    <td><strong class="color-red pl" data-plid="6746"></strong></td>
                ...
                <tr>
                    <td>蓝合单</td>
                    <td><strong class="color-red pl" data-plid="6743"></strong></td>
                ...
                <tr>
                    <td>蓝合双</td>
                    <td><strong class="color-red pl" data-plid="6744"></strong></td>

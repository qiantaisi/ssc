...
<div class="eveb_content">
    <div class="eveb_nav_sub">
        <ul class="clearfix">
            ...
            <c:if test="${not empty zfbzzInfo.skInfoList}"><li class="on"><a href="javascript:void(0)" onclick="parent.getPage('zhcz/zfbzz')">支付宝转账</a></li></c:if>
            ...
            <ul class="eveb_form">
                ...
                <li>
                    ...
                    <select id="payId" name="alipayId">
                        <c:forEach items="${systemAlipayResult.skInfoList}" var="item">

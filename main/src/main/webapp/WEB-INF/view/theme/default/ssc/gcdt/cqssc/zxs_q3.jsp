        ...
        <div class="hd clearfix">
            <div class="fr">
                <div class="T-tab clearfix"  style="margin-top: 4.4px; ">
                    <a href="javascript:void(0)" onclick="getSscSubPage('cqssc-zxs_q3')" class="active">前三组选三</a>
                    <a href="javascript:void(0)" onclick="getSscSubPage('cqssc-zxs_z3')">中三组选三</a>
...
<input type="hidden" data-plid="7531" id="pl5"/>
<input type="hidden" data-plid="7540" id="pl6"/>
<input type="hidden" data-plid="7549" id="pl7"/>
<input type="hidden" data-plid="7558" id="pl8"/>
<input type="hidden" data-plid="7567" id="pl9"/>
<input type="hidden" data-plid="7576" id="pl10"/>
<script>
    var playGroupId = 1;
    var playId = 224;

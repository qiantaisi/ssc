        ...
        <div class="help_list">
            ...
            <div class="help_col gfwf-help-col">
                <div class="gfwf-1">
                    <div class="gfwf-2" id="top">
                        <h1><a style=""></a></h1>
                        <span class="gamek-4">新疆时时彩玩法规则</span>
                    </div>
                    <br>
                    <div class="gfwf-3">
         ...
         <a onclick="javascript:document.getElementById('top').scrollIntoView()" href="javascript:;">回到顶部</a></br>
            ...
            <div class="help_col">
                ...
                <p>新疆时时彩由中国福利彩票发行管理中心组织，由新疆维吾尔自治区福利彩票发行中心在所辖区域内承销。新疆时时彩开奖时间：官网~每日早上10点~凌晨2点(每10分钟一期)，共96期。本公司新疆时时彩具体游戏规则请参考彩种介绍。</br>

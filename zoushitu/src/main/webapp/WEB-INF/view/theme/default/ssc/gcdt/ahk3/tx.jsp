    ...
    <table>
        ...
        <tr>
            <td data-name="豹子">
                ...
                <span class="pl" data-plid="11776"  style="float: left"></span>
            </td>
        </tr>
        <tr>
            <td data-name="顺子">
                <span style="float: left;padding-left: 184px">顺子</span>
                <span class="pl" data-plid="11775"  style="float: left"></span>
            </td>
        </tr>
        <tr>
            <td data-name="对子">
                <span style="float: left;padding-left: 184px">对子</span>
                <span class="pl" data-plid="11774"  style="float: left"></span>
            </td>
        </tr>
        <tr>
            <td data-name="三不同">
                <span style="float: left;padding-left: 184px">三不同</span>
                <span class="pl" data-plid="11773"  style="float: left"></span>
            </td>
        </tr>
        </tbody>
    </table>

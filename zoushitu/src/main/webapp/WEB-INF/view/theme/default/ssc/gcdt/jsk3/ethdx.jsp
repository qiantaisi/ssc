...
%>
<div class="cl-960">
   二同号单选@<span class="pl red" data-plid="11681"></span>
</div>
<div class="cl-604">
    ...
    <table class="jsks_table" style="margin-top: 25px;">
        <tbody>
        <tr>
            <td data-name="1">
                <span>1</span>
...
<input type="hidden" data-plid="11681" id="pl_jsks"/>
<script>

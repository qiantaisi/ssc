...
%>
<div class="cl-960">
    二字定位(中2@<font class="pl red" data-plid="10703"></font>)
</div>
<div class="cl-603">
    万位
</div>
<div class="cl-604">
    <table>
        ...
        <tr>
            <td data-name="0">
                <span>0</span>
                <span class="pl" data-group="万" data-plid="10703"></span>
            </td>
            <td data-name="1">
                <span>1</span>
               <span class="pl" data-group="万"  data-plid="10703"></span>
...
<div class="cl-604">
    <table>
        ...
        <tr>
            <td data-name="0">
                <span>0</span>
               <span class="pl" data-group="千" data-plid="10703"></span>
            </td>
            <td data-name="1">
                <span>1</span>
               <span class="pl" data-group="千" data-plid="10703"></span>
...
<div class="cl-604">
    <table>
        ...
        <tr>
            <td data-name="0">
                <span>0</span>
                <span class="pl" data-group="百" data-plid="10703"></span>
            </td>
            <td data-name="1">
                <span>1</span>
                <span class="pl" data-group="百" data-plid="10703"></span>
...
<div class="cl-604">
    <table>
        ...
        <tr>
            <td data-name="0">
                <span>0</span>
                <span class="pl" data-group="十" data-plid="10703"></span>
            </td>
            <td data-name="1">
                <span>1</span>
                <span class="pl" data-group="十" data-plid="10703"></span>
...
<div class="cl-604">
    <table>
        ...
        <tr>
            <td data-name="0">
                <span>0</span>
                <span class="pl" data-group="个" data-plid="10703"></span>
            </td>
            <td data-name="1">
                <span>1</span>
                <span class="pl" data-group="个" data-plid="10703"></span>
...
<input type="hidden" data-plid="10703" id="pl" />
<script>
    var playGroupId = 15;
    var playId = 388;
    ...
    function getZhudan(inputMoney, number) {
        ...
        $("[data-group='万']").each(function() {   //为每个匹配元素规定要运行的函数
            if ($(this).parent().hasClass("active")) {   //true 就执行
        ...
        if (wan.length > 0) {
            nameArr.push("万位");
            var tmp = [];
            $.each(wan, function(index, value) {    //函数用于遍历指定的对象和数组
                tmp.push(value);
            });
            dataArr.push(tmp);
        }
    ...
    function getZhushu() {
        ...
        var zhuShuArr = getFlagArrs(zhushu, 2);
        return getListShu(zhuShuArr, 2);
    }
</script>
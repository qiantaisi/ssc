...
<div class="page-group">
    <div class="page page-current" id="page-cqk-zz-zfbzz">
        ...
        <div class="content cl-700">
            <div class="list-block cl-708">
                ...
                <div class="cl-303">支付宝信息</div>
                <ul>
                    <li>
                        <div class="item-content item-link">
                            <div class="item-inner">
                                <div class="item-input">
                                    <input type="text" placeholder="请选择支付宝账号" id="inputSkInfo" readonly>
                                </div>
                            </div>
                        </div>
                    </li>

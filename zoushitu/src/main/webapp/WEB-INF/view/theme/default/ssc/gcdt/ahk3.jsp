...
<div class="page-group">
    <div class="page page-current" id="page-gcdt-ahk3">
        <header class="bar bar-nav">
            ...
            <h1 class="title">安徽快3</h1>
        </header>
        <c:import url="common/commonBet.jsp"/>
        <div class="content cl-601">
            <div class="cl-600" id="ssc-parent-menu">
                <div class="cl-602">
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/ahk3/hz.html">和值</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/ahk3/tx.html">通选</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/ahk3/sthdx.html">三同号单选</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/ahk3/sbt.html">三不同</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/ahk3/ethfx.html">二同号复选</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/ahk3/ethdx.html">二同号单选</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/ahk3/ebth.html">二不同号</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/ahk3/cbc.html">猜必出</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/ahk3/cbbc.html">猜必不出</a>
                </div>
            </div>

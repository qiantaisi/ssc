        ...
        <div class="content cl-601">
            <div class="cl-600" id="ssc-parent-menu">
                <div class="cl-602">
                    ...
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/ffssc/szp.html">数字盘</a>
                    <a href="javascript:void(0)" data-type="sub-menu" data-sub_menu_id="sub-menu-yzdw">一字定</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/ffssc/ezdw.html">二字定</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/ffssc/szdw.html">三字定</a>
                    ...
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/ffssc/ezhs.html">二字和</a>

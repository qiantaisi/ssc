...
<div class="help_col">
    ...
    <p>
        1.	根据《彩票管理条例》等有关规定，制定本规则。
        2.	中国福利彩票江苏省快三游戏（以下简称“快三”）由中国福利彩票发行管理中心和组织销售，江苏省福利
        彩票销售机构（以下称“江苏福彩机构”）在所辖区域内承销。 3.	快三采用计
        算机网络系统发行，在江苏福彩机构设置的销售网点销售，定期
        开奖。 4.	快三实行自愿购买，凡购买该彩票均被视为同意并
        遵守本规则。 5.	不得向未成年人出售彩票或兑付奖金。 本站江苏快三游
        戏每天进行82期，开奖时间为08:39至22:10，每隔10分钟开奖一次。快三采用专
        用电子开奖设备开奖，每期随机生成3个号码，作为当期中奖号码。开奖结
        果为三码 (百、十、个)。假设结果为1 、2 、3。<br></p>
</div>

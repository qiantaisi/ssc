...
<div class="page-group">
    <div class="page page-current" id="page-gcdt-wfssc">
        ...
        <div class="content cl-601">
            <div class="cl-600" id="ssc-parent-menu">
                <div class="cl-602">
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/wfssc/sm.html">双面</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/wfssc/szp.html">数字盘</a>
                    <a href="javascript:void(0)" data-type="sub-menu" data-sub_menu_id="sub-menu-yzdw">一字定</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/wfssc/ezdw.html">二字定</a>
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/wfssc/szdw.html">三字定</a>
                    ...
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/wfssc/ezhs.html">二字和</a>
                    ...
                    <a href="javascript:void(0)" data-type="page" data-url="<%=basePath%>ssc/gcdt/wfssc/lh.html">龙虎</a>
                </div>
            </div>
            ...
            <div id="sub-menu-list">
                <div class="cl-600 cl-610 hide" id="sub-menu-yzdw">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/yzdw_wdw.html">万定位</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/yzdw_qdw.html" href="javascript:void(0)">千定位</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/yzdw_bdw.html" href="javascript:void(0)">百定位</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/yzdw_sdw.html" href="javascript:void(0)">十定位</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/yzdw_gdw.html" href="javascript:void(0)">个定位</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-yzzh">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/yzzh_qw.html">全五一字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/yzzh_qs.html">前三一字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/yzzh_zs.html">中三一字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/yzzh_hs.html">后三一字组合</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-ezzh">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/ezzh_qs.html">前三二字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/ezzh_zs.html">中三二字组合</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/ezzh_hs.html">后三二字组合</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-zxs">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/zxs_qs.html">前三组选三</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/zxs_zs.html">中三组选三</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/zxs_hs.html">后三组选三</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-zxl">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/zxl_qs.html">前三组选六</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/zxl_zs.html">中三组选六</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/zxl_hs.html">后三组选六</a>
                    </div>
                </div>
                <div class="cl-600 cl-610 hide" id="sub-menu-kd">
                    <div class="cl-602">
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/kd_qs.html">前三跨度</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/kd_zs.html">中三跨度</a>
                        <a data-url="<%=basePath%>ssc/gcdt/wfssc/kd_hs.html">后三跨度</a>
                    </div>
                </div>
            </div>

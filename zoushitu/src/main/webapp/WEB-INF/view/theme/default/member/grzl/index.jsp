                            ...
                            <div class="item-content item-link">
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-input info_gr">
                                        ${userSession.qq}<a href="<%=basePath%>member/grzl/edit.html" class="edit_color"> 编辑</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-input">
                                        <input type="text" value="${userSession.balance}" readonly>
                                    </div>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="item-content">
                                ...
                                <div class="item-inner">
                                    ...
                                    <div class="item-input">
                                        <input type="text" value="${userSession.layerName}" readonly/>
                                    </div>
                                </div>
                            </div>
                        </li>

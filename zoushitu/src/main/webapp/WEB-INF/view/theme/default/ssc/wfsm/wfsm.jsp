    ...
    <div class="page page-current" id="page-wfsm-wfsm">
        ...
        <div class="content cl-700">
            <div class="buttons-tab cl-701" id="buttonsTabList">
                <a href="<%=basePath%>ssc/wfsm/wfsm.html?playGroupId=${playGroupId}" class="active button" data-id="btn-bqxq"><span>玩法说明</span></a>
                <a href="<%=basePath%>ssc/wfsm/lskj.html?playGroupId=${playGroupId}" class="button" data-id="btn-gdqc"><span>历史开奖</span></a>
            </div>

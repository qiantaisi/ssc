        ...
        <div class="content">
                <div class="card">
                    <div class="card-header" style="display:block;color:#000">
                        ...
                        <div style="font-size:0.6rem;color:#8D8D8D">活动时间： <fmt:formatDate value="${promotion.startTime}" pattern="yy/MM/dd" />~<fmt:formatDate value="${promotion.endTime}" pattern="yy/MM/dd" /></div>
                    </div>
                    <div valign="bottom" class="card-header color-white no-border no-padding" style="margin:10px 15px!important" >

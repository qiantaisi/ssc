...
<div>
    ...
    <table width="300" cellspacing="1" cellpadding="0" border="0" bgcolor="#CCCCCC" class="s-table">
        ...
        <tr align="center">
            <td height="25" bgcolor="#FFF7F0">选号：三连号通选</td>
        </tr>
        </tbody>
    </table>
    <p>
...
<div class="help_col">
    ...
    <p>
        1.	根据《彩票管理条例》等有关规定，制定本规则。 2.	中国福利彩票安徽省快三游戏（以下简称“快三”）由中国福利彩票发行管理中心和组织销售，安徽省福利彩票销售机构（以下称“安徽福彩机构”）在所辖区域内承销。 3.	快三采用计算机网络系统发行，在安徽福彩机构设置的销售网点销售，定期开奖。 4.	快三实行自愿购买，凡购买该彩票均被视为同意并遵守本规则。 5.	不得向未成年人出售彩票或兑付奖金。 本站安徽快三游戏每天进行82期，开奖时间为08:39至22:10，每隔10分钟开奖一次。快三采用专用电子开奖设备开奖，每期随机生成3个号码，作为当期中奖号码。开奖结果为三码 (百、十、个)。假设结果为1 、2 、3。<br></p>
</div>
